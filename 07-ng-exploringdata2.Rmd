...
In this section, we'll talk about the `purrr` package, which contains functions that allow you to map functions to all values in a vector, matrix, or list. \bigskip
