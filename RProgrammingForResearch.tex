...
\begin{verbatim}
##         time          X         Y         Z
## 1 2009-01-01 -0.6721175 -2.520364 -4.903970
## 2 2009-01-02 -2.8014628 -1.858642 -1.748226
## 3 2009-01-03 -0.6316121  1.926366  3.309551
\end{verbatim}
...
\begin{verbatim}
##         time stock      price
## 1 2009-01-01     X -0.6721175
## 2 2009-01-02     X -2.8014628
## 3 2009-01-03     X -0.6316121
## 4 2009-01-04     X -1.7757372
## 5 2009-01-05     X  0.3270331
\end{verbatim}
...
\begin{verbatim}
##         time          X          Y         Z
## 1 2009-01-01 -0.6721175 -2.5203642 -4.903970
## 2 2009-01-02 -2.8014628 -1.8586424 -1.748226
## 3 2009-01-03 -0.6316121  1.9263661  3.309551
## 4 2009-01-04 -1.7757372  4.1887439 -3.745826
## 5 2009-01-05  0.3270331  0.1914225 11.772710
\end{verbatim}
...
##   stock     N       mean       sd
##   <chr> <int>      <dbl>    <dbl>
## 1     X    10 -0.1817027 1.407375
## 2     Y    10 -0.7027929 2.229510
## 3     Z    10  1.3997251 5.130075
\end{verbatim}
...
Statistic & X & Y & Z\\
\hline
Mean (Std.dev.) & -0.18 (1.41) & -0.7 (2.23) & 1.4 (5.13)\\
\hline
N & 10 & 10 & 10\\
\hline
\end{tabular}
...
## 
## $b
## [1]  1.2846768  1.6704874 -0.4946559
## 
## $c
## [1] "a" "b" "c" "d"
\end{verbatim}
...
trailing whitespace to elements of a character vector with
...
\item
  ...
  the dataframe with the full dataset (\texttt{accident} in this case)
...
\item
  ...
  \texttt{accident} dataframe: \texttt{unique(accident\$state\_name)}.)
\end{itemize}
...
\StringTok{    }\KeywordTok{filter}\NormalTok{(state_name ==}\StringTok{ }\NormalTok{which_state) %>%}
\StringTok{    }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{drunk_dr =} \KeywordTok{factor}\NormalTok{(drunk_dr,}
           ...
           \DataTypeTok{daytime =} \KeywordTok{factor}\NormalTok{(daytime, }\DataTypeTok{labels =} \KeywordTok{c}\NormalTok{(}\StringTok{"Nighttime"}\NormalTok{, }\StringTok{"Daytime"}\NormalTok{))) %>%}
\StringTok{    }\KeywordTok{group_by}\NormalTok{(daytime, month, drunk_dr) %>%}
\StringTok{    }\NormalTok{dplyr::}\KeywordTok{summarize}\NormalTok{(}\DataTypeTok{accidents =} \KeywordTok{n}\NormalTok{()) %>%}
\StringTok{    }\KeywordTok{ggplot}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =} \NormalTok{daytime, }\DataTypeTok{y =} \NormalTok{accidents, }\DataTypeTok{group =} \NormalTok{daytime)) +}\StringTok{ }
\StringTok{    }\KeywordTok{geom_boxplot}\NormalTok{() +}\StringTok{ }
\StringTok{    }\KeywordTok{facet_wrap}\NormalTok{(~}\StringTok{ }\NormalTok{drunk_dr, }\DataTypeTok{ncol =} \DecValTok{2}\NormalTok{) +}
\StringTok{    }\KeywordTok{xlab}\NormalTok{(}\StringTok{"Time of day"}\NormalTok{) +}\StringTok{ }\KeywordTok{ylab}\NormalTok{(}\StringTok{"# of monthly accidents"}\NormalTok{) +}\StringTok{ }
...
\subsection{Writing a mapping
function}\label{writing-a-mapping-function}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{accident <-}\StringTok{ }\KeywordTok{read_csv}\NormalTok{(}\StringTok{"data/accident.csv"}\NormalTok{) %>%}
\StringTok{  }\KeywordTok{select}\NormalTok{(STATE, LATITUDE, LONGITUD, DRUNK_DR) %>%}
\StringTok{  }\NormalTok{dplyr::}\KeywordTok{rename}\NormalTok{(}\DataTypeTok{state =} \NormalTok{STATE,}
                ...
                \DataTypeTok{drunk_dr =} \NormalTok{DRUNK_DR) %>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{drunk_dr =} \NormalTok{drunk_dr >}\StringTok{ }\DecValTok{0}\NormalTok{,}
         \DataTypeTok{lat =} \KeywordTok{ifelse}\NormalTok{(lat >}\StringTok{ }\DecValTok{80}\NormalTok{, }\OtherTok{NA}\NormalTok{, lat),}
         \DataTypeTok{long =} \KeywordTok{ifelse}\NormalTok{(long >}\StringTok{ }\DecValTok{99}\NormalTok{, }\OtherTok{NA}\NormalTok{, long)) %>%}
\StringTok{  }\KeywordTok{left_join}\NormalTok{(state_fips, }\DataTypeTok{by =} \StringTok{"state"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\StringTok{    }\NormalTok{ggplot2::}\KeywordTok{geom_point}\NormalTok{(}\DataTypeTok{data =} \NormalTok{state_accidents, }
                        \KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =} \NormalTok{long, }\DataTypeTok{y =} \NormalTok{lat, }\DataTypeTok{group =} \OtherTok{NULL}\NormalTok{),}
...
\begin{center}\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-484-1} \end{center}
...
\begin{center}\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-485-1} \end{center}
...
\begin{center}\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-486-1} \end{center}
...
\begin{center}\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-487-1} \end{center}
