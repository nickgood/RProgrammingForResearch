...
\item
  ...
  \texttt{geom\_point()} geom from \texttt{ggplot2}. Try using different
  constant or mapped values with the \texttt{color} aesthetic.
\item
...
\item
  Try customizing the number of bins used for the histogram plotted in
  the previous step.
\item
...
\item
  In the previous section of the group exercise, you should have
  identified that the four top teams in this tournament were Spain, the
  Netherlands, Germany, and Uruguay. Create a histogram using data only
  from these four citis for the amount of time each player played. Use
  the color aesthetic of the histogram to show team.
\item
...
\begin{center}\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-229-1} \end{center}
...
\begin{center}\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-229-2} \end{center}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{worldcup }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(Team }\OperatorTok{%in%}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"Spain"}\NormalTok{, }\StringTok{"Netherlands"}\NormalTok{, }\StringTok{"Germany"}\NormalTok{, }\StringTok{"Uruguay"}\NormalTok{)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{ggplot}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ Time, }\DataTypeTok{fill =}\NormalTok{ Team)) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{geom_histogram}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{center}\includegraphics[width=0.7\textwidth]{RProgrammingForResearch_files/figure-latex/unnamed-chunk-237-1} \end{center}
...
\begin{center}\includegraphics[width=0.5\textwidth]{RProgrammingForResearch_files/figure-latex/unnamed-chunk-238-1} \end{center}
...
\begin{center}\includegraphics[width=0.7\textwidth]{RProgrammingForResearch_files/figure-latex/unnamed-chunk-240-1} \end{center}
...
\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-247-1.pdf}
...
\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-249-1.pdf}
...
\begin{center}\includegraphics[width=0.8\textwidth]{RProgrammingForResearch_files/figure-latex/unnamed-chunk-251-1} \end{center}
...
\begin{center}\includegraphics[width=0.9\textwidth]{RProgrammingForResearch_files/figure-latex/unnamed-chunk-254-1} \end{center}
...
\includegraphics[width=0.32\textwidth]{RProgrammingForResearch_files/figure-latex/unnamed-chunk-257-1}
\includegraphics[width=0.32\textwidth]{RProgrammingForResearch_files/figure-latex/unnamed-chunk-257-2}
\includegraphics[width=0.32\textwidth]{RProgrammingForResearch_files/figure-latex/unnamed-chunk-257-3}
...
\includegraphics[width=\textwidth]{RProgrammingForResearch_files/figure-latex/unnamed-chunk-258-1}
...
\begin{center}\includegraphics[width=0.8\textwidth]{RProgrammingForResearch_files/figure-latex/unnamed-chunk-259-1} \end{center}
...
\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-264-1.pdf}
...
\caption{\label{tab:unnamed-chunk-304}My new table}
\centering
\begin{tabular}[t]{r|c}
\hline
...
\begin{verbatim}
##         time          X         Y         Z
## 1 2009-01-01 -0.6620706 -1.133716 -2.174028
## 2 2009-01-02  1.9368273 -2.908011  1.265979
## 3 2009-01-03  0.2598184 -1.763428 -6.299783
\end{verbatim}
...
\begin{verbatim}
##         time stock      price
## 1 2009-01-01     X -0.6620706
## 2 2009-01-02     X  1.9368273
## 3 2009-01-03     X  0.2598184
## 4 2009-01-04     X  1.1668797
## 5 2009-01-05     X  1.1947831
\end{verbatim}
...
\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-326-1.pdf}
...
\begin{verbatim}
##         time          X          Y         Z
## 1 2009-01-01 -0.6620706 -1.1337164 -2.174028
## 2 2009-01-02  1.9368273 -2.9080109  1.265979
## 3 2009-01-03  0.2598184 -1.7634276 -6.299783
## 4 2009-01-04  1.1668797 -3.3807693  4.723238
## 5 2009-01-05  1.1947831  0.6947629 -2.757425
\end{verbatim}
...
##   stock     N       mean       sd
##   <chr> <int>      <dbl>    <dbl>
## 1     X    10  0.4465816 1.129727
## 2     Y    10 -0.4137613 1.908841
## 3     Z    10 -0.9035416 3.113959
\end{verbatim}
...
Statistic & X & Y & Z\\
\hline
Mean (Std.dev.) & 0.45 (1.13) & -0.41 (1.91) & -0.9 (3.11)\\
\hline
N & 10 & 10 & 10\\
\hline
\end{tabular}
...
\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-345-2.pdf}
...
\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-346-1.pdf}
...
\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-346-2.pdf}
...
\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-375-1.pdf}
...
\begin{center}\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-421-1} \end{center}
...
\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-426-1.pdf}
...
\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-427-1.pdf}
...
\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-431-1.pdf}
...
\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-432-1.pdf}
