...
you will save yourself time, and make it easier to plan out, later
steps.
...
\begin{verbatim}
##         time          X           Y          Z
## 1 2009-01-01  0.4484438 -0.53024161 -0.9569356
## 2 2009-01-02 -0.2377868  0.01039085 -5.8387744
## 3 2009-01-03  0.4806800 -0.52580919 -1.5391964
\end{verbatim}
...
\begin{verbatim}
##         time stock      price
## 1 2009-01-01     X  0.4484438
## 2 2009-01-02     X -0.2377868
## 3 2009-01-03     X  0.4806800
## 4 2009-01-04     X -1.0865382
## 5 2009-01-05     X  0.8083432
\end{verbatim}
...
## 2 2009-01-02 -0.2377868  0.01039085 -5.8387744
## 3 2009-01-03  0.4806800 -0.52580919 -1.5391964
## 4 2009-01-04 -1.0865382 -2.83611527  0.2395006
## 5 2009-01-05  0.8083432 -1.84511238  4.3357972
\end{verbatim}
...
deviationsfor each of the three stocks, you could use \texttt{spread} to
rearrange the final summary to create an attractive table.
...
##   stock     N        mean        sd
##   <chr> <int>       <dbl>     <dbl>
## 1     X    10  0.03813427 0.9220671
## 2     Y    10 -0.34717917 1.4890216
## 3     Z    10 -0.21105920 3.0624193
\end{verbatim}
...
Statistic & X & Y & Z\\
\hline
Mean (Std.dev.) & 0.04 (0.92) & -0.35 (1.49) & -0.21 (3.06)\\
\hline
N & 10 & 10 & 10\\
\hline
\end{tabular}
...
a bit cleaner. Again, this is using regular expressions, which we're
...
\item
  ...
  (your welcome to use the whiteboards) what a tidy version of this data
  would look like.
\item
...
\tightlist
\item
  Try exploring the interactive visualization at
...
\item
  ...
  the raw data. Navigate this page to figure out how you can get this
  raw data for the whole county for 2015. Save 2015 data to your
  computer. What is the structure of how this data is saved (e.g.,
...
\item
  Try to write the code to create this plot. I will add one example
  answer after class, but I'd like you to try to figure it out
  yourselves first.
\end{itemize}
