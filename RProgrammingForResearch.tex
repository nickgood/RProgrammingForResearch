...
\begin{verbatim}
##         time           X          Y           Z
## 1 2009-01-01 -0.08561929 -1.1726912 -3.02142515
## 2 2009-01-02  0.68469511  0.5373214  1.29517753
## 3 2009-01-03  0.51622645  4.2928754  0.02610941
\end{verbatim}
...
\begin{verbatim}
##         time stock       price
## 1 2009-01-01     X -0.08561929
## 2 2009-01-02     X  0.68469511
## 3 2009-01-03     X  0.51622645
## 4 2009-01-04     X -0.84548672
## 5 2009-01-05     X -0.38683398
\end{verbatim}
...
## 2 2009-01-02  0.68469511  0.5373214  1.29517753
## 3 2009-01-03  0.51622645  4.2928754  0.02610941
## 4 2009-01-04 -0.84548672  0.2522417 -0.58005070
## 5 2009-01-05 -0.38683398  0.8820744 -5.35828597
\end{verbatim}
...
##   stock     N       mean        sd
##   <chr> <int>      <dbl>     <dbl>
## 1     X    10 -0.2765174 0.6307938
## 2     Y    10 -0.0934539 1.9333159
## 3     Z    10 -2.9642594 4.7422106
\end{verbatim}
...
Statistic & X & Y & Z\\
\hline
Mean (Std.dev.) & -0.28 (0.63) & -0.09 (1.93) & -2.96 (4.74)\\
\hline
N & 10 & 10 & 10\\
\hline
\end{tabular}
...
\begin{center}\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-440-1} \end{center}
...
\begin{center}\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-444-1} \end{center}
...
Now try using functions from the \texttt{broom} package to pull the same
information about the model, but in a ``tidy'' format. First, use
\texttt{glance} to get some summary information about the model:
...
Next, use the \texttt{tidy} function to get model coefficients in a tidy
format:
...
Use the \texttt{tidy} function to add model output (e.g., predictions,
...
Use the output from \texttt{augment} to create a plot of the original
data, with the predicted values used to plot a fitted line.
...
\StringTok{  }\KeywordTok{geom_point}\NormalTok{(}\DataTypeTok{size =} \FloatTok{0.5}\NormalTok{, }\DataTypeTok{alpha =} \FloatTok{0.5}\NormalTok{) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{geom_line}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ temp, }\DataTypeTok{y =}\NormalTok{ .fitted), }\DataTypeTok{color =} \StringTok{"red"}\NormalTok{, }\DataTypeTok{size =} \DecValTok{2}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-454-1.pdf}
...
\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-459-1.pdf}
...
\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-460-1.pdf}
...
\StringTok{  }\KeywordTok{filter}\NormalTok{(month }\OperatorTok{%in%}\StringTok{ }\DecValTok{6}\OperatorTok{:}\DecValTok{8}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
