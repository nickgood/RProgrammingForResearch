...
\begin{verbatim}
##         time          X          Y         Z
## 1 2009-01-01  0.5867770 0.07607449  3.380947
## 2 2009-01-02  0.9828584 1.72913524 -7.232307
## 3 2009-01-03 -1.5327947 1.39674068  8.649832
\end{verbatim}
...
\begin{verbatim}
##         time stock      price
## 1 2009-01-01     X  0.5867770
## 2 2009-01-02     X  0.9828584
## 3 2009-01-03     X -1.5327947
## 4 2009-01-04     X  1.7181519
## 5 2009-01-05     X -0.9209012
\end{verbatim}
...
## 2 2009-01-02  0.9828584  1.72913524 -7.232307
## 3 2009-01-03 -1.5327947  1.39674068  8.649832
## 4 2009-01-04  1.7181519 -0.16760066 -4.797661
## 5 2009-01-05 -0.9209012 -0.13377060 -2.529436
\end{verbatim}
...
##   stock     N        mean        sd
##   <chr> <int>       <dbl>     <dbl>
## 1     X    10 -0.07718312 0.9673994
## 2     Y    10  0.65157007 1.7006071
## 3     Z    10  0.11207326 4.7501075
\end{verbatim}
...
Statistic & X & Y & Z\\
\hline
Mean (Std.dev.) & -0.08 (0.97) & 0.65 (1.7) & 0.11 (4.75)\\
\hline
N & 10 & 10 & 10\\
\hline
\end{tabular}
...
\begin{center}\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-460-1} \end{center}
...
\begin{center}\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-464-1} \end{center}
...
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{date =} \KeywordTok{dmy_hm}\NormalTok{(date), }
         ...
         \DataTypeTok{daytime =} \KeywordTok{hour}\NormalTok{(date) }\OperatorTok{%in%}\StringTok{ }\KeywordTok{c}\NormalTok{(}\DecValTok{7}\OperatorTok{:}\DecValTok{19}\NormalTok{),}
