...
\begin{verbatim}
##         time         X             Y          Z
## 1 2009-01-01 0.5544887  0.0006445481  0.2639765
## 2 2009-01-02 0.2487938 -1.2761624699 -4.6602022
## 3 2009-01-03 1.0190118 -0.3456462371 -0.4407474
\end{verbatim}
...
\begin{verbatim}
##         time stock     price
## 1 2009-01-01     X 0.5544887
## 2 2009-01-02     X 0.2487938
## 3 2009-01-03     X 1.0190118
## 4 2009-01-04     X 1.3525913
## 5 2009-01-05     X 0.8671538
\end{verbatim}
...
## 2 2009-01-02 0.2487938 -1.2761624699 -4.6602022
## 3 2009-01-03 1.0190118 -0.3456462371 -0.4407474
## 4 2009-01-04 1.3525913 -0.0527473330  2.8565050
## 5 2009-01-05 0.8671538 -3.9562347997  5.6176736
\end{verbatim}
...
##   stock     N       mean        sd
##   <chr> <int>      <dbl>     <dbl>
## 1     X    10  0.4534009 0.7486022
## 2     Y    10  0.6435893 2.6556952
## 3     Z    10 -0.1302997 2.7660754
\end{verbatim}
...
Statistic & X & Y & Z\\
\hline
Mean (Std.dev.) & 0.45 (0.75) & 0.64 (2.66) & -0.13 (2.77)\\
\hline
N & 10 & 10 & 10\\
\hline
\end{tabular}
...
## 
## $b
## [1] -1.3347538  0.3079137  0.2150808
## 
## $c
## [1] "a" "b" "c" "d"
\end{verbatim}
...
\item
  ...
  \end{itemize}
\item
  The \texttt{data-raw} directory will have your raw data as well as
  some R scripts (``.R'') with code for cleaning up the raw data. The
  homework requires you to pull FARS data from several years. We'll
  create a subdirectory in \texttt{data-raw} that will just have that
  data. In the ``Files'' pane in RStudio, navigate into the
  \texttt{data-raw} subdirectory. Use the ``New Folder'' button to
  create a new subdirectory within the \texttt{data-raw} subdirectory.
  Name it \texttt{yearly\_person\_data}.
\item
