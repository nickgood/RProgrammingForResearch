...
\begin{center}\includegraphics[width=0.7\textwidth]{RProgrammingForResearch_files/figure-latex/unnamed-chunk-227-1} \end{center}
...
\begin{center}\includegraphics[width=0.5\textwidth]{RProgrammingForResearch_files/figure-latex/unnamed-chunk-228-1} \end{center}
...
\begin{center}\includegraphics[width=0.7\textwidth]{RProgrammingForResearch_files/figure-latex/unnamed-chunk-230-1} \end{center}
...
\begin{center}\includegraphics[width=0.8\textwidth]{RProgrammingForResearch_files/figure-latex/unnamed-chunk-241-1} \end{center}
...
\begin{center}\includegraphics[width=0.8\textwidth]{RProgrammingForResearch_files/figure-latex/unnamed-chunk-242-1} \end{center}
...
\begin{center}\includegraphics[width=0.9\textwidth]{RProgrammingForResearch_files/figure-latex/unnamed-chunk-244-1} \end{center}
...
\begin{center}\includegraphics[width=0.9\textwidth]{RProgrammingForResearch_files/figure-latex/unnamed-chunk-245-1} \end{center}
...
\begin{center}\includegraphics[width=0.9\textwidth]{RProgrammingForResearch_files/figure-latex/unnamed-chunk-246-1} \end{center}
...
\includegraphics[width=0.32\textwidth]{RProgrammingForResearch_files/figure-latex/unnamed-chunk-247-1}
\includegraphics[width=0.32\textwidth]{RProgrammingForResearch_files/figure-latex/unnamed-chunk-247-2}
\includegraphics[width=0.32\textwidth]{RProgrammingForResearch_files/figure-latex/unnamed-chunk-247-3}
...
\includegraphics[width=\textwidth]{RProgrammingForResearch_files/figure-latex/unnamed-chunk-248-1}
...
\begin{center}\includegraphics[width=0.8\textwidth]{RProgrammingForResearch_files/figure-latex/unnamed-chunk-249-1} \end{center}
...
\begin{center}\includegraphics[width=0.8\textwidth]{RProgrammingForResearch_files/figure-latex/unnamed-chunk-250-1} \end{center}
...
\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-254-1.pdf}
...
\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-255-1.pdf}
...
\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-260-1.pdf}
...
\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-261-1.pdf}
...
\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-262-1.pdf}
...
\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-275-2.pdf}
...
\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-275-3.pdf}
...
\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-275-4.pdf}
...
\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-275-5.pdf}
...
\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-275-6.pdf}
...
\addcontentsline{toc}{chapter}{(PART) Part III: Intermediate}
...
\begin{verbatim}
##         time          X         Y           Z
## 1 2009-01-01  0.4414909 -1.265471  2.92844268
## 2 2009-01-02  0.1980135  1.040923 -0.02404393
## 3 2009-01-03 -0.4795941 -1.943823  0.18561220
\end{verbatim}
...
\begin{verbatim}
##         time stock       price
## 1 2009-01-01     X  0.44149094
## 2 2009-01-02     X  0.19801347
## 3 2009-01-03     X -0.47959413
## 4 2009-01-04     X -0.73700584
## 5 2009-01-05     X  0.03971162
\end{verbatim}
...
\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-316-1.pdf}
...
\begin{verbatim}
##         time           X          Y           Z
## 1 2009-01-01  0.44149094 -1.2654713  2.92844268
## 2 2009-01-02  0.19801347  1.0409235 -0.02404393
## 3 2009-01-03 -0.47959413 -1.9438234  0.18561220
## 4 2009-01-04 -0.73700584  0.2053306  2.93362583
## 5 2009-01-05  0.03971162  0.9072897 -2.05091123
\end{verbatim}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{stock_summary <-}\StringTok{ }\NormalTok{long_stocks %>%}\StringTok{ }
\StringTok{  }\KeywordTok{group_by}\NormalTok{(stock) %>%}
...
##   stock     N        mean        sd
##   <chr> <int>       <dbl>     <dbl>
## 1     X    10 -0.32073317 0.7104632
## 2     Y    10 -1.30345020 1.6834203
## 3     Z    10  0.01238234 3.0140165
\end{verbatim}
...
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\StringTok{"Mean (Std.dev.)"} \NormalTok{=}\StringTok{ }\KeywordTok{paste0}\NormalTok{(}\KeywordTok{round}\NormalTok{(mean, }\DecValTok{2}\NormalTok{), }\StringTok{" ("}\NormalTok{,}
                                    \KeywordTok{round}\NormalTok{(sd, }\DecValTok{2}\NormalTok{), }\StringTok{")"}\NormalTok{)) %>%}
\StringTok{  }\KeywordTok{select}\NormalTok{(-}\StringTok{ }\NormalTok{mean, -}\StringTok{ }\NormalTok{sd) %>%}
\StringTok{  }\KeywordTok{gather}\NormalTok{(}\DataTypeTok{key =} \StringTok{"Statistic"}\NormalTok{, }\DataTypeTok{value =} \StringTok{"Value"}\NormalTok{, -stock) %>%}
\StringTok{  }\KeywordTok{spread}\NormalTok{(}\DataTypeTok{key =} \NormalTok{stock, }\DataTypeTok{value =} \NormalTok{Value) %>%}
...
Statistic & X & Y & Z\\
\hline
Mean (Std.dev.) & -0.32 (0.71) & -1.3 (1.68) & 0.01 (3.01)\\
\hline
N & 10 & 10 & 10\\
\hline
\end{tabular}
...
\begin{Highlighting}[]
\NormalTok{mexico <-}\StringTok{ }\KeywordTok{full_join}\NormalTok{(mex_deaths, mex_exp, }\DataTypeTok{by =} \StringTok{"day"}\NormalTok{) %>%}
\StringTok{        }\KeywordTok{select}\NormalTok{(day, deaths, temp_mean) %>%}
...
\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-325-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{foo <-}\StringTok{ }\KeywordTok{strsplit}\NormalTok{(}\KeywordTok{as.character}\NormalTok{(ebola$variable), }\DataTypeTok{split =} \StringTok{"_"}\NormalTok{)}
...
\NormalTok{ebola$type <-}\StringTok{ }\KeywordTok{factor}\NormalTok{(bar[ , }\DecValTok{1}\NormalTok{])}
\NormalTok{ebola$country <-}\StringTok{ }\KeywordTok{factor}\NormalTok{(bar[ , }\DecValTok{2}\NormalTok{])}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ebola <-}\StringTok{ }\KeywordTok{select}\NormalTok{(ebola, -Day, -variable) %>%}
\StringTok{         }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{Date =} \KeywordTok{mdy}\NormalTok{(Date))}
\KeywordTok{head}\NormalTok{(ebola)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{case_sum <-}\StringTok{ }\KeywordTok{group_by}\NormalTok{(ebola, country) %>%}
...
\NormalTok{ebola <-}\StringTok{ }\KeywordTok{mutate}\NormalTok{(ebola, }
                \DataTypeTok{country =} \KeywordTok{factor}\NormalTok{(country, }\DataTypeTok{levels =} \NormalTok{case_sum$country))}
\KeywordTok{levels}\NormalTok{(ebola$country)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-335-2.pdf}
...
\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-336-1.pdf}
...
\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-336-2.pdf}
...
\begin{Highlighting}[]
\NormalTok{ebola <-}\StringTok{ }\KeywordTok{read_csv}\NormalTok{(ebola_url) %>%}
\StringTok{        }\KeywordTok{gather}\NormalTok{(variable, count, -Date, -Day) %>%}
\StringTok{        }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{type =} \KeywordTok{sub}\NormalTok{(}\StringTok{"_.*"}\NormalTok{, }\StringTok{""}\NormalTok{, variable),}
               \DataTypeTok{country =} \KeywordTok{sub}\NormalTok{(}\StringTok{".*_"}\NormalTok{, }\StringTok{""}\NormalTok{, variable)) %>%}
\StringTok{        }\KeywordTok{select}\NormalTok{(-Day, -variable) %>%}
\StringTok{        }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{Date =} \KeywordTok{mdy}\NormalTok{(Date)) %>%}
\StringTok{        }\KeywordTok{spread}\NormalTok{(type, count) %>%}
\StringTok{        }\KeywordTok{filter}\NormalTok{(!}\KeywordTok{is.na}\NormalTok{(Cases) &}\StringTok{ }\NormalTok{!}\KeywordTok{is.na}\NormalTok{(Deaths))}
...
\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-338-1.pdf}
...
\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-339-1.pdf}
...
\StringTok{  }\KeywordTok{summarize}\NormalTok{(}\DataTypeTok{Time =} \KeywordTok{mean}\NormalTok{(Time), }\DataTypeTok{Passes =} \KeywordTok{mean}\NormalTok{(Passes),}
            ...
            \DataTypeTok{Saves =} \KeywordTok{mean}\NormalTok{(Saves)) %>%}
\StringTok{  }\KeywordTok{gather}\NormalTok{(}\DataTypeTok{key =} \NormalTok{var, }\DataTypeTok{value =} \NormalTok{mean) %>%}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{(positions <-}\StringTok{ }\KeywordTok{unique}\NormalTok{(worldcup$Position))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{for(i in }\DecValTok{1}\NormalTok{:}\KeywordTok{nrow}\NormalTok{(pos_est))\{}
        \NormalTok{pos_df <-}\StringTok{ }\NormalTok{worldcup %>%}
\StringTok{          }\KeywordTok{filter}\NormalTok{(Position ==}\StringTok{ }\NormalTok{positions[i]) }
        \NormalTok{pos_mod <-}\StringTok{ }\KeywordTok{glm}\NormalTok{(Passes ~}\StringTok{ }\NormalTok{Time,}
                       \DataTypeTok{data =} \NormalTok{pos_df,}
                       \DataTypeTok{family =} \KeywordTok{poisson}\NormalTok{(}\DataTypeTok{link =} \StringTok{"log"}\NormalTok{))}
        \NormalTok{pos_coefs <-}\StringTok{ }\KeywordTok{summary}\NormalTok{(pos_mod)$coefficients[}\DecValTok{2}\NormalTok{, }\DecValTok{1}\NormalTok{:}\DecValTok{2}\NormalTok{]}
        \NormalTok{pos_est[i, }\KeywordTok{c}\NormalTok{(}\StringTok{"est"}\NormalTok{, }\StringTok{"se"}\NormalTok{)] <-}\StringTok{ }\NormalTok{pos_coefs}
\NormalTok{\}}
\NormalTok{pos_est[}\DecValTok{1}\NormalTok{:}\DecValTok{2}\NormalTok{, ]}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{pos_est <-}\StringTok{ }\NormalTok{pos_est %>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{lower_ci =} \NormalTok{est -}\StringTok{ }\FloatTok{1.96} \NormalTok{*}\StringTok{ }\NormalTok{se,}
         \DataTypeTok{upper_ci =} \NormalTok{est +}\StringTok{ }\FloatTok{1.96} \NormalTok{*}\StringTok{ }\NormalTok{se)}
...
\begin{Highlighting}[]
\NormalTok{pos_est <-}\StringTok{ }\NormalTok{pos_est %>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{rr_est =} \KeywordTok{exp}\NormalTok{(}\DecValTok{90} \NormalTok{*}\StringTok{ }\NormalTok{est),}
         \DataTypeTok{rr_low =} \KeywordTok{exp}\NormalTok{(}\DecValTok{90} \NormalTok{*}\StringTok{ }\NormalTok{lower_ci),}
         \DataTypeTok{rr_high =} \KeywordTok{exp}\NormalTok{(}\DecValTok{90} \NormalTok{*}\StringTok{ }\NormalTok{upper_ci))}
\NormalTok{pos_est %>%}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{pos_est <-}\StringTok{ }\KeywordTok{arrange}\NormalTok{(pos_est, rr_est) %>%}
\StringTok{        }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{position =} \KeywordTok{factor}\NormalTok{(position,}
                                 \DataTypeTok{levels =} \NormalTok{position))}
\NormalTok{pos_est %>%}\StringTok{ }\KeywordTok{select}\NormalTok{(position, est)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{ggplot}\NormalTok{(pos_est, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =} \NormalTok{rr_low, }\DataTypeTok{y =} \NormalTok{position)) +}\StringTok{ }
\StringTok{        }\KeywordTok{geom_segment}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{xend =} \NormalTok{rr_high, }\DataTypeTok{yend =} \NormalTok{position)) +}\StringTok{ }
\StringTok{        }\KeywordTok{geom_point}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =} \NormalTok{rr_est, }\DataTypeTok{y =} \NormalTok{position)) +}\StringTok{ }
\StringTok{        }\KeywordTok{theme_few}\NormalTok{() +}\StringTok{ }
...
\StringTok{        }\KeywordTok{scale_x_continuous}\NormalTok{(}\KeywordTok{paste}\NormalTok{(}\StringTok{"Relative rate of passes}\CharTok{\textbackslash{}n}\StringTok{per"}\NormalTok{,}
                           ...
                           \DataTypeTok{limits =} \KeywordTok{c}\NormalTok{(}\FloatTok{1.0}\NormalTok{, }\KeywordTok{max}\NormalTok{(pos_est$rr_high))) +}\StringTok{ }
...
\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-366-1.pdf}
...
\NormalTok{for(i in }\DecValTok{1}\NormalTok{:}\DecValTok{5}\NormalTok{)\{}
  \NormalTok{if(i %%}\StringTok{ }\DecValTok{2} \NormalTok{==}\StringTok{ }\DecValTok{1}\NormalTok{)\{}
    \KeywordTok{print}\NormalTok{(i)}
  \NormalTok{\}}
\NormalTok{\}}
\end{Highlighting}
...
\NormalTok{for(i in }\DecValTok{1}\NormalTok{:}\DecValTok{100}\NormalTok{)\{}
  \NormalTok{if(i %%}\StringTok{ }\DecValTok{3} \NormalTok{==}\StringTok{ }\DecValTok{0} \NormalTok{&}\StringTok{ }\NormalTok{i %%}\StringTok{ }\DecValTok{5} \NormalTok{==}\StringTok{ }\DecValTok{0}\NormalTok{)\{}
    \KeywordTok{print}\NormalTok{(}\StringTok{"FizzBuzz"}\NormalTok{)}
  \NormalTok{\} else if(i %%}\StringTok{ }\DecValTok{3} \NormalTok{==}\StringTok{ }\DecValTok{0}\NormalTok{)\{}
    \KeywordTok{print}\NormalTok{(}\StringTok{"Fizz"}\NormalTok{)}
  \NormalTok{\} else if(i %%}\StringTok{ }\DecValTok{5} \NormalTok{==}\StringTok{ }\DecValTok{0}\NormalTok{)\{}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{subset_nepali <-}\StringTok{ }\NormalTok{function(}\DataTypeTok{datafr =} \NormalTok{nepali, child_id)\{}
  \NormalTok{datafr <-}\StringTok{ }\NormalTok{datafr %>%}
\StringTok{    }\KeywordTok{filter}\NormalTok{(id ==}\StringTok{ }\NormalTok{child_id)}
...
\begin{Highlighting}[]
\NormalTok{subset_nepali <-}\StringTok{ }\NormalTok{function(}\DataTypeTok{datafr =} \NormalTok{nepali, child_id)\{}
  \NormalTok{if(!(}\StringTok{"id"} \NormalTok{%in%}\StringTok{ }\KeywordTok{colnames}\NormalTok{(datafr)))\{}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{titanic_train %>%}\StringTok{ }\KeywordTok{select}\NormalTok{(Name) %>%}\StringTok{ }\KeywordTok{slice}\NormalTok{(}\DecValTok{1}\NormalTok{:}\DecValTok{3}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\StringTok{  }\KeywordTok{select}\NormalTok{(Name) %>%}\StringTok{ }
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{mrs <-}\StringTok{ }\KeywordTok{str_detect}\NormalTok{(titanic_train$Name, }\StringTok{"Mrs."}\NormalTok{)}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{titanic_train %>%}
\StringTok{  }\KeywordTok{filter}\NormalTok{(}\KeywordTok{str_detect}\NormalTok{(Name, }\StringTok{"Mrs."}\NormalTok{)) %>%}
...
\begin{Highlighting}[]
\NormalTok{titanic_train %>%}
\StringTok{  }\KeywordTok{filter}\NormalTok{(}\KeywordTok{grepl}\NormalTok{(}\StringTok{"Mrs."}\NormalTok{, Name)) %>%}
\StringTok{  }\KeywordTok{select}\NormalTok{(Name) %>%}
\StringTok{  }\KeywordTok{slice}\NormalTok{(}\DecValTok{1}\NormalTok{:}\DecValTok{3}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\NormalTok{titanic_train %>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{mrs =} \KeywordTok{str_extract}\NormalTok{(Name, }\StringTok{"Mrs."}\NormalTok{)) %>%}
\StringTok{  }\KeywordTok{select}\NormalTok{(Name, mrs) %>%}
\StringTok{  }\KeywordTok{slice}\NormalTok{(}\DecValTok{1}\NormalTok{:}\DecValTok{3}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\NormalTok{titanic_train %>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{title =} \KeywordTok{str_extract}\NormalTok{(Name, }\StringTok{"Mr}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{.|Mrs}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{."}\NormalTok{)) %>%}
\StringTok{  }\KeywordTok{select}\NormalTok{(Name, title) %>%}
\StringTok{  }\KeywordTok{slice}\NormalTok{(}\DecValTok{1}\NormalTok{:}\DecValTok{3}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\NormalTok{titanic_train %>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{title =} \KeywordTok{str_extract}\NormalTok{(Name, }\StringTok{"Mr(s)*}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{."}\NormalTok{)) %>%}
\StringTok{  }\KeywordTok{select}\NormalTok{(Name, title) %>%}
\StringTok{  }\KeywordTok{slice}\NormalTok{(}\DecValTok{1}\NormalTok{:}\DecValTok{3}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\NormalTok{titanic_train %>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{title =} \KeywordTok{str_extract}\NormalTok{(Name, }\StringTok{"M[a-z]+}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{."}\NormalTok{)) %>%}
\StringTok{  }\KeywordTok{select}\NormalTok{(Name, title) %>%}
\StringTok{  }\KeywordTok{slice}\NormalTok{(}\DecValTok{1}\NormalTok{:}\DecValTok{3}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\NormalTok{titanic_train %>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{title =} \KeywordTok{str_extract}\NormalTok{(Name, }\StringTok{",}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{s[A-Za-z]*}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{.}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{s"}\NormalTok{)) %>%}
\StringTok{  }\KeywordTok{select}\NormalTok{(title) %>%}
\StringTok{  }\KeywordTok{slice}\NormalTok{(}\DecValTok{1}\NormalTok{:}\DecValTok{3}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{head}\NormalTok{(}\KeywordTok{str_match}\NormalTok{(titanic_train$Name,}
...
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{title =} 
           \KeywordTok{str_match}\NormalTok{(Name, }\StringTok{",}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{s([A-Za-z]*)}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{.}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{s"}\NormalTok{)[ , }\DecValTok{2}\NormalTok{]) %>%}
\StringTok{  }\KeywordTok{select}\NormalTok{(Name, title) %>%}
\StringTok{  }\KeywordTok{slice}\NormalTok{(}\DecValTok{1}\NormalTok{:}\DecValTok{3}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{title =} 
           \KeywordTok{str_match}\NormalTok{(Name, }\StringTok{",}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{s([A-Za-z]*)}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{.}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{s"}\NormalTok{)[ , }\DecValTok{2}\NormalTok{]) %>%}
\StringTok{  }\KeywordTok{group_by}\NormalTok{(title) %>%}\StringTok{ }\KeywordTok{summarize}\NormalTok{(}\DataTypeTok{n =} \KeywordTok{n}\NormalTok{()) %>%}
\StringTok{  }\KeywordTok{arrange}\NormalTok{(}\KeywordTok{desc}\NormalTok{(n)) %>%}\StringTok{ }\KeywordTok{slice}\NormalTok{(}\DecValTok{1}\NormalTok{:}\DecValTok{5}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\NormalTok{titanic_train %>%}
\StringTok{  }\KeywordTok{filter}\NormalTok{(}\KeywordTok{str_detect}\NormalTok{(Name, }\StringTok{"^A"}\NormalTok{)) %>%}
\StringTok{  }\KeywordTok{select}\NormalTok{(Name) %>%}
\StringTok{  }\KeywordTok{slice}\NormalTok{(}\DecValTok{1}\NormalTok{:}\DecValTok{3}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\NormalTok{titanic_train %>%}
\StringTok{  }\KeywordTok{filter}\NormalTok{(}\KeywordTok{str_detect}\NormalTok{(Name, }\StringTok{"I\{2,\}"}\NormalTok{)) %>%}
\StringTok{  }\KeywordTok{select}\NormalTok{(Name) %>%}
\StringTok{  }\KeywordTok{slice}\NormalTok{(}\DecValTok{1}\NormalTok{:}\DecValTok{3}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\NormalTok{titanic_train %>%}
\StringTok{  }\KeywordTok{filter}\NormalTok{(}\KeywordTok{str_detect}\NormalTok{(Name, }\StringTok{"Anders[eo]n"}\NormalTok{)) %>%}
\StringTok{  }\KeywordTok{select}\NormalTok{(Name)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\NormalTok{titanic_train %>%}
\StringTok{  }\KeywordTok{filter}\NormalTok{(}\KeywordTok{str_detect}\NormalTok{(Name, }\StringTok{"^[AB]"}\NormalTok{)) %>%}
\StringTok{  }\KeywordTok{select}\NormalTok{(Name) %>%}
\StringTok{  }\KeywordTok{slice}\NormalTok{(}\DecValTok{1}\NormalTok{:}\DecValTok{3}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\NormalTok{titanic_train %>%}
\StringTok{  }\KeywordTok{filter}\NormalTok{(}\KeywordTok{str_detect}\NormalTok{(Name, }\StringTok{"[bB]$"}\NormalTok{)) %>%}
\StringTok{  }\KeywordTok{select}\NormalTok{(Name) }
\end{Highlighting}
\end{Shaded}
...
\begin{center}\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-407-1} \end{center}
...
\StringTok{  }\KeywordTok{select}\NormalTok{(DAY:MINUTE) %>%}
\StringTok{  }\KeywordTok{select}\NormalTok{(-DAY_WEEK) %>%}
\StringTok{  }\KeywordTok{unite}\NormalTok{(date, DAY:MINUTE, }\DataTypeTok{sep =} \StringTok{"-"}\NormalTok{, }\DataTypeTok{remove =} \OtherTok{FALSE}\NormalTok{) %>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{date =} \KeywordTok{dmy_hm}\NormalTok{(date), }
         ...
         \DataTypeTok{weekend =} \NormalTok{weekday %in%}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"Saturday"}\NormalTok{, }\StringTok{"Sunday"}\NormalTok{)) }

\NormalTok{accident %>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(!}\KeywordTok{is.na}\NormalTok{(yday)) %>%}
\StringTok{  }\KeywordTok{group_by}\NormalTok{(yday) %>%}
\StringTok{  }\KeywordTok{summarize}\NormalTok{(}\DataTypeTok{accidents =} \KeywordTok{n}\NormalTok{(),}
            \DataTypeTok{weekend =} \KeywordTok{first}\NormalTok{(weekend)) %>%}
\StringTok{  }\KeywordTok{ggplot}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =} \NormalTok{yday, }\DataTypeTok{y =} \NormalTok{accidents, }\DataTypeTok{color =} \NormalTok{weekend)) +}\StringTok{ }
\StringTok{  }\KeywordTok{geom_point}\NormalTok{(}\DataTypeTok{alpha =} \FloatTok{0.5}\NormalTok{) +}\StringTok{ }
\StringTok{  }\KeywordTok{xlab}\NormalTok{(}\StringTok{"Day of the year in 2015"}\NormalTok{) +}\StringTok{ }
\StringTok{  }\KeywordTok{ylab}\NormalTok{(}\StringTok{"# of fatal accidents"}\NormalTok{) +}\StringTok{ }
\StringTok{  }\KeywordTok{theme_few}\NormalTok{() +}\StringTok{ }
\StringTok{  }\KeywordTok{geom_smooth}\NormalTok{(}\DataTypeTok{se =} \OtherTok{FALSE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{center}\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-408-1} \end{center}
...
\begin{center}\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-412-1} \end{center}
...
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{date =} \KeywordTok{dmy_hm}\NormalTok{(date), }
         ...
         \DataTypeTok{daytime =} \KeywordTok{hour}\NormalTok{(date) %in%}\StringTok{ }\KeywordTok{c}\NormalTok{(}\DecValTok{7}\NormalTok{:}\DecValTok{19}\NormalTok{),}
...
\NormalTok{for(which_state in state_list)\{}
  \NormalTok{a <-accident %>%}
\StringTok{    }\KeywordTok{filter}\NormalTok{(state_name ==}\StringTok{ }\NormalTok{which_state) %>%}
...
\StringTok{    }\KeywordTok{group_by}\NormalTok{(daytime, month, drunk_dr) %>%}
\StringTok{    }\KeywordTok{summarize}\NormalTok{(}\DataTypeTok{accidents =} \KeywordTok{n}\NormalTok{()) %>%}
\StringTok{    }\KeywordTok{ggplot}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =} \NormalTok{daytime, }\DataTypeTok{y =} \NormalTok{accidents, }\DataTypeTok{group =} \NormalTok{daytime)) +}\StringTok{ }
\StringTok{    }\KeywordTok{geom_boxplot}\NormalTok{() +}\StringTok{ }
\StringTok{    }\KeywordTok{facet_wrap}\NormalTok{(~}\StringTok{ }\NormalTok{drunk_dr, }\DataTypeTok{ncol =} \DecValTok{2}\NormalTok{) +}
\StringTok{    }\KeywordTok{xlab}\NormalTok{(}\StringTok{"Time of day"}\NormalTok{) +}\StringTok{ }\KeywordTok{ylab}\NormalTok{(}\StringTok{"# of monthly accidents"}\NormalTok{) +}\StringTok{ }
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{foo %>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(col_1 ==}\StringTok{ }\DecValTok{1}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{bar$some_logical_values}
\end{Highlighting}
\end{Shaded}
...
## 
## $b
## [1]  0.05561247  1.34481249 -1.64699046
## 
## $c
## [1] "a" "b" "c" "d"
\end{verbatim}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{north_carolina <-}\StringTok{ }\NormalTok{us_map %>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(region ==}\StringTok{ "north carolina"}\NormalTok{)}
\KeywordTok{ggplot}\NormalTok{(north_carolina, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =} \NormalTok{long, }\DataTypeTok{y =} \NormalTok{lat)) +}
\StringTok{  }\KeywordTok{geom_point}\NormalTok{()}
\end{Highlighting}
\end{Shaded}

\begin{center}\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-435-1} \end{center}

If you try to plot lines, however, you'll have a problem:

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{carolinas <-}\StringTok{ }\NormalTok{us_map %>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(}\KeywordTok{str_detect}\NormalTok{(region, }\StringTok{"carolina"}\NormalTok{))}
\KeywordTok{ggplot}\NormalTok{(carolinas, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =} \NormalTok{long, }\DataTypeTok{y =} \NormalTok{lat)) +}\StringTok{ }
\StringTok{  }\KeywordTok{geom_path}\NormalTok{()}
\end{Highlighting}
\end{Shaded}

\begin{center}\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-436-1} \end{center}
...
\begin{center}\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-438-1} \end{center}
...
\begin{center}\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-439-1} \end{center}
...
\begin{center}\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-441-1} \end{center}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{serial <-}\StringTok{ }\NormalTok{serial %>%}
\StringTok{    }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{long =} \NormalTok{-}\FloatTok{76.8854} \NormalTok{+}\StringTok{ }\FloatTok{0.00017022} \NormalTok{*}\StringTok{ }\NormalTok{x,}
           \DataTypeTok{lat  =} \FloatTok{39.23822} \NormalTok{+}\StringTok{ }\FloatTok{1.371014e-04} \NormalTok{*}\StringTok{ }\NormalTok{y,}
           \DataTypeTok{tower =} \NormalTok{Type ==}\StringTok{ "cell-site"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{baltimore <-}\StringTok{ }\KeywordTok{subset}\NormalTok{(baltimore, }
                    \NormalTok{subregion %in%}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"baltimore city"}\NormalTok{,}
...
\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-448-1.pdf}
...
\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-451-1.pdf}
...
\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-455-1.pdf}
...
\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-456-1.pdf}
...
\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-457-1.pdf}
...
\begin{center}\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-462-1} \end{center}
...
\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-467-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{serial_phone <-}\StringTok{ }\KeywordTok{read.csv}\NormalTok{(}\StringTok{"data/serial_phone_data.csv"}\NormalTok{) %>%}\StringTok{ }
\StringTok{        }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{Cell_Site =} \KeywordTok{substring}\NormalTok{(Cell_Site, }\DecValTok{1}\NormalTok{, }\DecValTok{4}\NormalTok{),}
               \DataTypeTok{Call_Time =} \KeywordTok{as.POSIXct}\NormalTok{(Call_Time, }\DataTypeTok{format =} \StringTok{"%d/%m/%y %H:%M"}\NormalTok{,}
                                      \DataTypeTok{tz =} \StringTok{"EST"}\NormalTok{)) %>%}
\StringTok{        }\KeywordTok{left_join}\NormalTok{(serial, }\DataTypeTok{by =} \KeywordTok{c}\NormalTok{(}\StringTok{"Cell_Site"} \NormalTok{=}\StringTok{ "Name"}\NormalTok{)) %>%}
\StringTok{        }\KeywordTok{select}\NormalTok{(Person_Called, Call_Time, Duration, long, lat) %>%}
\StringTok{        }\KeywordTok{filter}\NormalTok{(!(Person_Called %in%}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"incoming"}\NormalTok{, }\StringTok{"# + Adnan cell"}\NormalTok{))) %>%}
...
\begin{center}\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-470-1} \end{center}
...
\KeywordTok{mapdist}\NormalTok{(}\StringTok{"Fort Collins CO"}\NormalTok{,}
        \StringTok{"1 First St NE, Washington, DC"}\NormalTok{) %>%}
...
\begin{verbatim}
##              from    miles    hours
## 1 Fort Collins CO 1670.348 24.54444
\end{verbatim}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{titanic_train$Name[}\DecValTok{1}\NormalTok{]}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{str_to_upper}\NormalTok{(titanic_train$Name[}\DecValTok{1}\NormalTok{])}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{str_to_lower}\NormalTok{(titanic_train$Name[}\DecValTok{1}\NormalTok{])}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{str_to_title}\NormalTok{(}\KeywordTok{str_to_lower}\NormalTok{(titanic_train$Name[}\DecValTok{1}\NormalTok{]))}
\end{Highlighting}
\end{Shaded}
...
\begin{center}\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-478-1} \end{center}
...
\begin{center}\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-478-2} \end{center}
...
\begin{center}\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-478-3} \end{center}

\begin{itemize}
\tightlist
\item
  In general, there is a pattern of more fatal accidents during the
  daytime being unrelated to drunk driving versus related. The pattern
  is reversed for nighttime accidents. Use your function to see if you
  can find any states that don't follow this pattern.
\item
...
\item
  ...
  column called \texttt{state\_name}, you can use:
...
\CommentTok{# With package::function notation}
\NormalTok{make_state_plot <-}\StringTok{ }\NormalTok{function(datafr, which_state)\{}
  \NormalTok{a <-}\StringTok{ }\NormalTok{datafr %>%}
\StringTok{    }\NormalTok{dplyr::}\KeywordTok{filter}\NormalTok{(state_name ==}\StringTok{ }\NormalTok{which_state) %>%}
\StringTok{    }\NormalTok{dplyr::}\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{drunk_dr =} \KeywordTok{factor}\NormalTok{(drunk_dr,}
...
Example of using this function to create plots for all states that start
with ``C'':

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{states <-}\StringTok{ }\KeywordTok{unique}\NormalTok{(accident$state_name)}
\NormalTok{c_states <-}\StringTok{ }\NormalTok{states[}\KeywordTok{str_detect}\NormalTok{(states, }\StringTok{"^C"}\NormalTok{)]}

\NormalTok{for(state in c_states)\{}
  \NormalTok{state_plot <-}\StringTok{ }\KeywordTok{make_state_plot}\NormalTok{(}\DataTypeTok{datafr =} \NormalTok{accident,}
                                \DataTypeTok{which_state =} \NormalTok{state)}
  \KeywordTok{print}\NormalTok{(state_plot)}
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}

\begin{center}\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-480-1} \end{center}

\begin{center}\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-480-2} \end{center}

\begin{center}\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-480-3} \end{center}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{make_state_plot <-}\StringTok{ }\NormalTok{function(which_state, datafr)\{}
  \NormalTok{a <-}\StringTok{ }\NormalTok{datafr %>%}
\StringTok{    }\NormalTok{dplyr::}\KeywordTok{filter}\NormalTok{(state_name ==}\StringTok{ }\NormalTok{which_state) %>%}
\StringTok{    }\NormalTok{dplyr::}\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{drunk_dr =} \KeywordTok{factor}\NormalTok{(drunk_dr,}
                             \DataTypeTok{labels =} \KeywordTok{c}\NormalTok{(}\StringTok{"Unrelated to}\CharTok{\textbackslash{}n}\StringTok{drunk driving"}\NormalTok{,}
...
\NormalTok{north_states <-}\StringTok{ }\NormalTok{states[}\KeywordTok{str_detect}\NormalTok{(states, }\StringTok{"North"}\NormalTok{)]}
\KeywordTok{lapply}\NormalTok{(north_states, make_state_plot, }\DataTypeTok{datafr =} \NormalTok{accident)}
\end{Highlighting}
\end{Shaded}

\begin{center}\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-481-1} \end{center}

\begin{center}\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-481-2} \end{center}
...
\NormalTok{state_fips <-}\StringTok{ }\KeywordTok{read_delim}\NormalTok{(}\StringTok{"http://www2.census.gov/geo/docs/reference/state.txt"}\NormalTok{,}
                         \DataTypeTok{delim =} \StringTok{"|"}\NormalTok{) %>%}
\StringTok{  }\NormalTok{dplyr::}\KeywordTok{rename}\NormalTok{(}\DataTypeTok{state =} \NormalTok{STATE,}
                \DataTypeTok{state_name =} \NormalTok{STATE_NAME) %>%}
\StringTok{  }\NormalTok{dplyr::}\KeywordTok{select}\NormalTok{(state, state_name) %>%}
\StringTok{  }\NormalTok{dplyr::}\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{state =} \KeywordTok{as.integer}\NormalTok{(state))}

\NormalTok{accident <-}\StringTok{ }\KeywordTok{read_csv}\NormalTok{(}\StringTok{"data/accident.csv"}\NormalTok{) %>%}
\StringTok{  }\NormalTok{dplyr::}\KeywordTok{select}\NormalTok{(STATE, LATITUDE, LONGITUD, DRUNK_DR) %>%}
\StringTok{  }\NormalTok{dplyr::}\KeywordTok{rename}\NormalTok{(}\DataTypeTok{state =} \NormalTok{STATE,}
                \DataTypeTok{lat =} \NormalTok{LATITUDE,}
                \DataTypeTok{long =} \NormalTok{LONGITUD,}
                \DataTypeTok{drunk_dr =} \NormalTok{DRUNK_DR) %>%}
\StringTok{  }\NormalTok{dplyr::}\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{drunk_dr =} \NormalTok{drunk_dr >}\StringTok{ }\DecValTok{0}\NormalTok{) %>%}
\StringTok{  }\NormalTok{dplyr::}\KeywordTok{left_join}\NormalTok{(state_fips, }\DataTypeTok{by =} \StringTok{"state"}\NormalTok{) %>%}
\StringTok{  }\NormalTok{dplyr::}\KeywordTok{select}\NormalTok{(-state)}
\NormalTok{accident %>%}\StringTok{ }\KeywordTok{slice}\NormalTok{(}\DecValTok{1}\NormalTok{:}\DecValTok{5}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{state_summaries <-}\StringTok{ }\NormalTok{accident %>%}
\StringTok{  }\NormalTok{dplyr::}\KeywordTok{group_by}\NormalTok{(state_name) %>%}
\StringTok{  }\NormalTok{dplyr::}\KeywordTok{summarize_}\NormalTok{(}\DataTypeTok{n =} \NormalTok{~}\StringTok{ }\KeywordTok{n}\NormalTok{(),}
            \DataTypeTok{perc_drunk_dr =} \NormalTok{~}\StringTok{ }\DecValTok{100} \NormalTok{*}\StringTok{ }\KeywordTok{mean}\NormalTok{(drunk_dr)) }\CommentTok{# Because `drunk_dr` is }
                                            \CommentTok{# 0 / 1, the mean is the percent of }
                                            \CommentTok{# values where `drunk_dr` == 1.}
\NormalTok{state_summaries %>%}\StringTok{ }\KeywordTok{slice}\NormalTok{(}\DecValTok{1}\NormalTok{:}\DecValTok{5}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# With `choroplethr` package}
\KeywordTok{library}\NormalTok{(choroplethr)}
\NormalTok{state_summaries %>%}
\StringTok{  }\NormalTok{dplyr::}\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{state_name =} \KeywordTok{str_to_lower}\NormalTok{(state_name)) %>%}
\StringTok{  }\NormalTok{dplyr::}\KeywordTok{rename}\NormalTok{(}\DataTypeTok{region =} \NormalTok{state_name,}
                \DataTypeTok{value =} \NormalTok{n) %>%}
\StringTok{  }\KeywordTok{state_choropleth}\NormalTok{(}\DataTypeTok{title =} \StringTok{"Fatal accidents by state, 2015"}\NormalTok{,}
                   \DataTypeTok{legend =} \StringTok{"# of fatal accidents"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-484-1.pdf}
...
\StringTok{  }\NormalTok{dplyr::}\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{state_name =} \KeywordTok{str_to_lower}\NormalTok{(state_name)) %>%}
\StringTok{  }\NormalTok{dplyr::}\KeywordTok{rename}\NormalTok{(}\DataTypeTok{region =} \NormalTok{state_name,}
                \DataTypeTok{value =} \NormalTok{perc_drunk_dr) %>%}
\StringTok{  }\KeywordTok{state_choropleth}\NormalTok{(}\DataTypeTok{title =} \StringTok{"Percent of fatal accidents linked}\CharTok{\textbackslash{}n}\StringTok{to drunk driving, 2015"}\NormalTok{,}
                   \DataTypeTok{legend =} \StringTok{"% of fatal accidents}\CharTok{\textbackslash{}n}\StringTok{linked to drunk driving"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-484-2.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# It turns out that values like 77.7777, 88.8888, and 99.9999 are used as }
\CommentTok{# missing values of latitude (similar for 777.777, etc., for longitude)}
\NormalTok{accident <-}\StringTok{ }\NormalTok{accident %>%}
\StringTok{  }\NormalTok{dplyr::}\KeywordTok{filter}\NormalTok{(lat <}\StringTok{ }\DecValTok{75} \NormalTok{&}\StringTok{ }\NormalTok{long <}\StringTok{ }\DecValTok{777}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{texas <-}\StringTok{ }\KeywordTok{get_map}\NormalTok{(}\DataTypeTok{location =} \StringTok{"texas"}\NormalTok{, }\DataTypeTok{zoom =} \DecValTok{6}\NormalTok{, }\DataTypeTok{maptype =} \StringTok{"roadmap"}\NormalTok{)}
\KeywordTok{ggmap}\NormalTok{(texas, }\DataTypeTok{extent =} \StringTok{"device"}\NormalTok{) +}\StringTok{ }
\StringTok{  }\KeywordTok{geom_point}\NormalTok{(}\DataTypeTok{data =} \NormalTok{dplyr::}\KeywordTok{filter}\NormalTok{(accident, state_name ==}\StringTok{ "Texas"}\NormalTok{), }
             \KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =} \NormalTok{long, }\DataTypeTok{y =} \NormalTok{lat), }\DataTypeTok{alpha =} \FloatTok{0.2}\NormalTok{, }\DataTypeTok{size =} \FloatTok{0.5}\NormalTok{,}
             \DataTypeTok{color =} \StringTok{"red"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-486-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{map_fatal_accidents <-}\StringTok{ }\NormalTok{function(}\DataTypeTok{datafr =} \NormalTok{accident, which_state,}
                                \DataTypeTok{drunk_dr =} \OtherTok{FALSE}\NormalTok{)\{}
  \NormalTok{state_accidents <-}\StringTok{ }\NormalTok{datafr %>%}
\StringTok{    }\NormalTok{dplyr::}\KeywordTok{filter}\NormalTok{(state_name ==}\StringTok{ }\NormalTok{which_state)}
  \NormalTok{state_map_data <-}\StringTok{ }\NormalTok{ggplot2::}\KeywordTok{map_data}\NormalTok{(}\StringTok{"county"}\NormalTok{, }\DataTypeTok{region =} \NormalTok{which_state)}
  
  \NormalTok{accident_map <-}\StringTok{ }\NormalTok{ggplot2::}\KeywordTok{ggplot}\NormalTok{(state_map_data,}
                                  \NormalTok{ggplot2::}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =} \NormalTok{long, }\DataTypeTok{y =} \NormalTok{lat, }
                                               \DataTypeTok{group =} \NormalTok{subregion)) +}\StringTok{ }
\StringTok{    }\NormalTok{ggplot2::}\KeywordTok{geom_polygon}\NormalTok{(}\DataTypeTok{color =} \StringTok{"gray"}\NormalTok{, }\DataTypeTok{fill =} \OtherTok{NA}\NormalTok{) +}\StringTok{ }
\StringTok{    }\NormalTok{ggplot2::}\KeywordTok{theme_void}\NormalTok{() +}\StringTok{ }
\StringTok{    }\NormalTok{ggplot2::}\KeywordTok{geom_point}\NormalTok{(}\DataTypeTok{data =} \NormalTok{state_accidents, }
                        \NormalTok{ggplot2::}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =} \NormalTok{long, }\DataTypeTok{y =} \NormalTok{lat, }\DataTypeTok{group =} \OtherTok{NULL}\NormalTok{),}
                        \DataTypeTok{alpha =} \FloatTok{0.5}\NormalTok{, }\DataTypeTok{size =} \FloatTok{0.7} \NormalTok{)}
  
  \NormalTok{if(drunk_dr)\{}
    \NormalTok{accident_map <-}\StringTok{ }\NormalTok{accident_map +}\StringTok{ }
\StringTok{      }\NormalTok{ggplot2::}\KeywordTok{facet_wrap}\NormalTok{(~}\StringTok{ }\NormalTok{drunk_dr, }\DataTypeTok{ncol =} \DecValTok{2}\NormalTok{)}
  \NormalTok{\}}
  
  \KeywordTok{return}\NormalTok{(accident_map)}
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}
...
\begin{center}\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-488-1} \end{center}
...
\begin{center}\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-489-1} \end{center}
...
\begin{center}\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-490-1} \end{center}
...
\begin{center}\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-491-1} \end{center}

\chapter{Reproducible research \#2}\label{reproducible-research-2}

\href{https://github.com/geanders/RProgrammingForResearch/raw/master/slides/CourseNotes_Week9.pdf}{Download}
a pdf of the lecture slides covering this topic.

\section{R Notebooks}\label{r-notebooks}

From RStudio's
\href{http://rmarkdown.rstudio.com/r_notebooks.html}{article on R
Notebooks}:
...
R Notebooks are a new feature. Right now, if you want to use them, you
need to update to RStudio's Preview version. You can get that
\href{https://www.rstudio.com/products/rstudio/download/preview/}{here}.

You can render an R Notebook document to a final, static version (e.g.,
pdf, Word, HTML) just like an R Markdown file.

Therefore, you can use R Notebooks as an alternative to R Markdown, with
the ability to try out and change chunks interactively as you write the
document.

You can open a new R Notebook file by going in RStudio to ``File''
-\textgreater{} ``New File''. In the Preview version of RStudio, there's
an option there for ``R Notebook''.

As with R Markdown files, when you choose to create a new R Notebook
file, RStudio opens a skeleton file with some example text and
formatting already in the file.

The syntax is very similar to an R Markdown file, but the YAML now
specifies:
...
R Markdown \textbf{templates} can be used to change multiple elements of
the style of a rendered document. You can think of these as being the
document-level analog to the themes we've used with \texttt{ggplot}
objects.

To do this, some kind of style file is applied when rendering document.
For HTML documents, Cascading Style Sheets (CSS) (\texttt{.css}) can be
used to change the style of different elements. For pdf files, LaTeX
package (style) files (\texttt{.sty}) are used.

To open a new R Markdown file that uses a template, in RStudio, go to
``File'' -\textgreater{} ``New File'' -\textgreater{} ``R Markdown''
-\textgreater{} ``From Template''.

Different templates come with different R packages. A couple of
templates come with the \texttt{rmarkdown} package, which you likely
already have.

Many of these templates will only render to pdf.

To render a pdf from R Markdown, you need to have a version of TeX
installed on your computer. Like R, TeX is open source software. RStudio
recommends the following installations by system:
...
The \texttt{tufte} package has templates for creating handouts typeset
like Edward Tufte's books.

This package includes templates for creating both pdf and HTML documents
in this style.

The package includes special functions like \texttt{newthought}, special
chunk options like \texttt{fig.fullwidth}, and special knitr engines
like \texttt{marginfigure}. Special features available in the tufte
template include:
...
The \texttt{rticles} package has templates for several journals:
...
\item
  ACS publications (\emph{Journal of the American Chemical Society},
  \emph{Environmental Science \& Technology})
\item
  Elsevier publications
\end{itemize}

Some of these templates create a whole directory, with several files
besides the .Rmd file. For example, the template for \emph{The R
Journal} includes:
...
\item
  ``RJournal.sty'': A LaTeX package (style) file specific to \emph{The R
  Journal}. This file tells LaTeX how to render all the elements in your
  article in the style desired by this journal.
\item
  ``RJreferences.bib'': A BibTeX file, where you can save citation
  information for all references in your article.
\item
  ``Rlogo.png'': An example figure (the R logo).
\end{itemize}

Once you render the R Markdown document from this template, you'll end
up with some new files in the directory:

\begin{itemize}
\tightlist
\item
  ``{[}your file name{]}.tex'': A TeX file with the content from your R
  Markdown file. This will be ``wrapped'' with some additional
  formatting input to create ``RJwrapper.tex''.
\item
  ``RJwrapper.tex'': A TeX file that includes both the content from your
  R Markdown file and additional formatting input. Typically, you will
  submit this file (along with the BibTeX, any figure and image files,
  and possibly the style file) to the journal.
\item
  ``RJwrapper.pdf'': The rendered pdf file (what the published article
  would look like)
\end{itemize}

This template files will often require some syntax that looks more like
LaTeX than Markdown.

For example, for the template for \emph{The R Journal}, you need to use
\texttt{\textbackslash{}citep\{\}} and
\texttt{\textbackslash{}citet\{\}} to include citations. These details
will depend on the style file of the template.

As a note, you can always use raw LaTeX in R Markdown documents, not
just in documents you're creating with a template. You just need to be
careful not to mix the two. For example, if you use a LaTeX environment
to begin an itemized list (e.g., with \texttt{begin\{itemize\}}), you
must start each item with \texttt{item}, not \texttt{-}.

You can create your own template. You create it as part of a custom R
package, and then will have access to the template once you've installed
the package. This can be useful if you often write documents in a
certain style, or if you ever work somewhere with certain formatting
requirements for reports.

RStudio has full instructions for creating your own template:
...
So far, you have run much of your analysis within a single R script or R
Markdown file. Often, any associated data are within the same working
directory as your script or R Markdown file, but the files for one
project are not separated from files for other projects.

As you move to larger projects, this kind of set-up won't work as well.
Instead, you'll want to start keeping all materials for a project in a
single and exclusive directory.

Often, it helps to organize the files in a project directory into
subdirectories. Common subdirectories include:

\begin{itemize}
\tightlist
\item
  \texttt{data-raw}: Raw data and R scripts to clean the raw data.
\item
  \texttt{data}: Cleaned data, often saved as \texttt{.RData} after
  being generated by a script in \texttt{data-raw}.
\item
  \texttt{R}: Code for any functions used in analysis.
\item
  \texttt{reports}: Any final products rendered from R Markdown and
  their original R Markdown files (e.g., paper drafts, reports,
  presentations).
\end{itemize}

\subsection{Creating R Projects}\label{creating-r-projects}

RStudio allows you to create ``Projects'' to organize code, data, and
results within a directory. When you create a project, RStudio adds a
file with the extension ``.Rproj'' to the directory.

There are some advantages to setting a directory to be an R Project. The
project:

\begin{itemize}
\tightlist
\item
  Automatically uses the directory as your current working directory
  when you open the project.
\item
  Coordinates well with git version control and GitHub repository
  system.
\item
  Opens a ``Files'' window for navigating project files in an RStudio
  pane when you open the project.
\end{itemize}

You can create a new project from scratch or from an existing directory.

To create an R project from a working directory, in RStudio go to
``File'' -\textgreater{} ``New Project'' -\textgreater{} ``New
Directory''. You can then choose where you want to save the new project
directory.

\section{In-course exercise}\label{in-course-exercise-8}

\subsection{Trying out templates}\label{trying-out-templates}

\begin{itemize}
\tightlist
\item
  Open a ``Tufte'' template document. To open a new document from a
  template, in RStudio go to ``File'' -\textgreater{} ``New File''
  -\textgreater{} ``R Markdown'' -\textgreater{} ``From Template''. If
  ``Tufte Handout'' does not show up as a choice, install and load the
  \texttt{tufte} package, restart R, and try again.
\item
  Render the document to an HTML and open it in a browser. Explore the
  rendered document. What elements does it include that are not typical
  for R Markdown documents?
\item
  Now go and look at the .Rmd file. Find the spots where these new
  elements are specified in the R Markdown file. How are elements like
  margin plots and all caps at the starts of some paragraphs included in
  the document?
\item
  Download and install the \texttt{rticles} package. Create a new
  document using the template for \emph{The R Journal}. When you do
  that, a whole directory will be copied to your current working
  directory. Check out the files in that directory. If you have a
  version of TeX installed on your computer, try compiling the example
  file.
\item
  Select three or four key journals in your field. Go to the journal's
  website and see if you can figure out:
...
\subsection{Organizing a project}\label{organizing-a-project}

In this part of the group exercise, you will set up an R Project to use
for the next homework assignment. You will want to set up a similar
project for your group project.

\begin{itemize}
\tightlist
\item
  First, you need to create a new project. In RStudio, go to ``File''
  -\textgreater{} ``New Project'' -\textgreater{} ``New Directory''.
  Choose where you want to save this directory and what you want to name
  it.
\item
  If the R Project does not automatically open once you make it,
  navigate to the ``.Rproj'' file created for the project and
  double-click on that. Alternatively, you can go to ``File''
  -\textgreater{} ``Open Project''.
\item
  Use \texttt{getwd} once you've opened your project to determine which
  working directory is automatically used for the project.
\item
  Once you open the project, one of the RStudio panes should have a tab
  called ``Files''. This shows the files in this project directory and
  allows you to navigate through them. Currently, you won't have any
  files other than the R project file (``.Rproj''). As a next step,
  create several subdirectories. We'll use these to structure the code,
  data, and R Markdown files for your homework. Create the following
  subdirectories (you can use the ``New Folder'' button in the RStudio
  ``Files'' pane):
  ...
  \end{itemize}
\item
  The \texttt{data-raw} directory will ultimately have your raw data as
  well as some R scripts with code for cleaning up the raw data. The
  homework requires you to pull FARS data from several years. Create a
  subdirectory in \texttt{data-raw} that will just have that data. In
  the ``Files'' pane in RStudio, navigate into the \texttt{data-raw}
  subdirectory. Use the ``New Folder'' button to create a new
  subdirectory within the \texttt{data-raw} subdirectory. Name it
  \texttt{yearly\_person\_data}.
\item
  Download FARS data from the years 1999 to 2010. From each year, pull
  out the ``person'' file. Save these yearly ``person'' files in the
  \texttt{yearly\_person\_data} subdirectory you created. As a file
  name, use ``person\_'' and then the year. For example, if you are
  saving this file for 1999 in the form of a csv, you would name the
  file ``person\_1999.csv''.
\item
  The \texttt{writing} subdirectory will have your R Markdown file and
  its output. Create a new R Markdown file (``File'' -\textgreater{}
  ``New File'' -\textgreater{} ``R Markdown'') and save it to this
  subdirectory. You can change the name and date for the file if you'd
  like. Delete all the text that comes as a default. Write a piece of
  code that lists the files you saved in
  \texttt{data-raw/yearly\_person\_data}. Remember that the working
  directory for an R Markdown file is the directory in which it's saved,
  so you'll need to use a relative pathname that goes up one directory
  (\texttt{..}) and then goes into \texttt{data-raw} and
  \texttt{yearly\_person\_data}.
\item
  If you have time, go to the
  \href{https://crashstats.nhtsa.dot.gov/Api/Public/ViewPublication/812316}{FARS
  documentation} and find out more about which variables are included in
  this data set and which values they can have.
\end{itemize}

\subsection{Linking your project with a GitHub
repository}\label{linking-your-project-with-a-github-repository}

\begin{itemize}
\item
  If you do not already have one, sign up for a GitHub account. The free
  option is fine.
\item
  If you do not already have git installed on your computer, install it:
  \url{https://git-scm.com/downloads}
\item
  Open a shell and configure git. For example, I would open a shell and
  run:
...
\end{verbatim}
\item
  Restart RStudio. go to ``RStudio'' -\textgreater{} ``Preferences''
  -\textgreater{}``Git/SVN''. Choose ``Enable version control''. If
  RStudio doesn't find yourversion of git in the ``Git executable'' box,
  browse for it.
\item
  Open your FARS analysis project in RStudio. Change your Project
  settings to initialize git for this project (see the course notes for
  tips on how to do that).
\item
  Try changing a few things in files you have in that project directory
  (or add a new file). Commit those changes using the ``Commit'' window.
  After you commit the changes, look at the ``History'' window to see
  the history of your commits.
\item
  Create an empty GitHub repository for the project. Give it the same
  name as the name of your R project directory.
\item
  Create an RSA key in RStudio and add it as an SSH key in your GitHub
  settings.
\item
  Add this empty GitHub repository as the remote branch of your local
...
\item
  Try making some more changes to your local repository. Commit the
  changes, then use the green up arrow in the Git window to push the
