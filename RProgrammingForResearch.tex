...
\subsection{Meaningful labels}\label{meaningful-labels}
...
\begin{center}\includegraphics[width=0.4\textwidth]{RProgrammingForResearch_files/figure-latex/unnamed-chunk-227-1} \end{center}
