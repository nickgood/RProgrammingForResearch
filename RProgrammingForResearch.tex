...
\StringTok{"daily_show_guests.csv"} \OperatorTok{%in%}\StringTok{ }\KeywordTok{list.files}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
##  [2] "App-1"                                                      
##  [3] "App-2"                                                      
##  [4] "country_timeseries.csv"                                     
##  [5] "daily_show_guests.csv"                                      
##  [6] "deaths-weather.csv"                                         
##  [7] "DRUG_CLASS_I_Mean_Cmax_Trough_Efficacy_R_DATA_ANALYSIS.xlsx"
##  [8] "example_choropleth.Rdata"                                   
##  [9] "fars_colorado.RData"                                        
## [10] "icd-10.xls"                                                 
## [11] "ICU_Data_Code_Sheet.pdf"                                    
## [12] "icu.sas7bdat"                                               
## [13] "ld_genetics.txt"                                            
## [14] "measles_data"                                               
## [15] "mexico_deaths.csv"                                          
## [16] "mexico_exposure.csv"                                        
## [17] "serial_map_data.csv"                                        
## [18] "serial_phone_data.csv"                                      
## [19] "titanic.csv"
\end{verbatim}
...
\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-148-1.pdf}

\subsection{Piping}\label{piping-1}
...
\tightlist
\item
  Copy the following ``piped'' code into an R script. Figure out what
  each line does, and add comments to each line of code describing what
  the code is doing.
\end{itemize}
...
\CommentTok{# Copy this code to an R script and add comments describing what each line is doing}
\KeywordTok{library}\NormalTok{(haven)}
\NormalTok{icu <-}\StringTok{ }\KeywordTok{read_sas}\NormalTok{(}\StringTok{"data/icu.sas7bdat"}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{select}\NormalTok{(ID, AGE, GENDER) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{rename}\NormalTok{(}\DataTypeTok{id =}\NormalTok{ ID,}
         \DataTypeTok{age =}\NormalTok{ AGE, }
         \DataTypeTok{gender =}\NormalTok{ GENDER) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{gender =} \KeywordTok{factor}\NormalTok{(gender, }\DataTypeTok{levels =} \KeywordTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{1}\NormalTok{), }\DataTypeTok{labels =} \KeywordTok{c}\NormalTok{(}\StringTok{"Male"}\NormalTok{, }\StringTok{"Female"}\NormalTok{)),}
         \DataTypeTok{id =} \KeywordTok{as.character}\NormalTok{(id)) }\OperatorTok{%>%}\StringTok{ }
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ebola_liberia <-}\StringTok{ }\KeywordTok{read_csv}\NormalTok{(}\StringTok{"data/country_timeseries.csv"}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{select}\NormalTok{(Date, Cases_Liberia, Deaths_Liberia) }\OperatorTok{%>%}\StringTok{  }
\StringTok{  }\KeywordTok{rename}\NormalTok{(}\DataTypeTok{date =}\NormalTok{ Date, }
         \DataTypeTok{cases =}\NormalTok{ Cases_Liberia, }
         \DataTypeTok{deaths =}\NormalTok{ Deaths_Liberia) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{ratio =}\NormalTok{ deaths }\OperatorTok{/}\StringTok{ }\NormalTok{cases) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{date =} \KeywordTok{mdy}\NormalTok{(date)) }\OperatorTok{%>%}\StringTok{ }
...
\KeywordTok{ggplot}\NormalTok{(}\KeywordTok{subset}\NormalTok{(ca_measles, city }\OperatorTok{%in%}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"LOS ANGELES"}\NormalTok{, }\StringTok{"SAN DIEGO"}\NormalTok{, }\StringTok{"ORANGE"}\NormalTok{)),}
...
\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-151-1.pdf}
...
\begin{center}\includegraphics[width=0.6\textwidth]{RProgrammingForResearch_files/figure-latex/unnamed-chunk-163-1} \end{center}
...
\StringTok{  }\KeywordTok{top_n}\NormalTok{(}\DataTypeTok{n =} \DecValTok{1}\NormalTok{, }\DataTypeTok{wt =}\NormalTok{ Time)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{worldcup }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{rownames_to_column}\NormalTok{(}\DataTypeTok{var =} \StringTok{"Name"}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(Time }\OperatorTok{==}\StringTok{ }\KeywordTok{max}\NormalTok{(Time))}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\NormalTok{worldcup }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(Position }\OperatorTok{==}\StringTok{ "Goalkeeper"}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{brazil_players <-}\StringTok{ }\NormalTok{worldcup }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(Team }\OperatorTok{==}\StringTok{ "Brazil"} \OperatorTok{&}\StringTok{ }\NormalTok{Position }\OperatorTok{!=}\StringTok{ "Goalkeeper"}\NormalTok{) }
\KeywordTok{head}\NormalTok{(brazil_players)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\NormalTok{worldcup }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{group_by}\NormalTok{(Position) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{summarize}\NormalTok{(}\DataTypeTok{max_saves =} \KeywordTok{max}\NormalTok{(Saves))}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\NormalTok{worldcup }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(Position }\OperatorTok{==}\StringTok{ "Forward"}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{group_by}\NormalTok{(Team) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{summarize}\NormalTok{(}\DataTypeTok{n_forwards =} \KeywordTok{n}\NormalTok{(),}
            \DataTypeTok{total_forward_shots =} \KeywordTok{sum}\NormalTok{(Shots)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{arrange}\NormalTok{(}\KeywordTok{desc}\NormalTok{(total_forward_shots))}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\NormalTok{worldcup }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(Position }\OperatorTok{==}\StringTok{ "Defender"}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{top_n}\NormalTok{(}\DataTypeTok{n =} \DecValTok{1}\NormalTok{, }\DataTypeTok{wt =}\NormalTok{ Tackles)}
\end{Highlighting}
\end{Shaded}
...
\begin{center}\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-225-1} \end{center}

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# With piping}
\NormalTok{worldcup }\OperatorTok{%>%}\StringTok{ }
...
\begin{center}\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-225-2} \end{center}
...
\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-226-1.pdf}
...
\begin{Highlighting}[]
\NormalTok{worldcup }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\NormalTok{tibble}\OperatorTok{::}\KeywordTok{rownames_to_column}\NormalTok{(}\DataTypeTok{var =} \StringTok{"Name"}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(Team }\OperatorTok{%in%}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"Spain"}\NormalTok{, }\StringTok{"Netherlands"}\NormalTok{, }\StringTok{"Germany"}\NormalTok{, }\StringTok{"Uruguay"}\NormalTok{)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{ggplot}\NormalTok{() }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{geom_point}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ Shots, }\DataTypeTok{y =}\NormalTok{ Tackles, }\DataTypeTok{color =}\NormalTok{ Position, }\DataTypeTok{shape =}\NormalTok{ Team)) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{geom_text}\NormalTok{(}\DataTypeTok{mapping =} \KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ Shots, }\DataTypeTok{y =}\NormalTok{ Tackles, }
                          \DataTypeTok{color =}\NormalTok{ Position, }\DataTypeTok{label =}\NormalTok{ Name), }
...
Create a scatterplot of player time versus passes. Use color to show
whether the player was on one of the top 4 teams or not.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{worldcup }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{top_4 =}\NormalTok{ Team }\OperatorTok{%in%}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"Spain"}\NormalTok{, }\StringTok{"Netherlands"}\NormalTok{, }\StringTok{"Germany"}\NormalTok{, }\StringTok{"Uruguay"}\NormalTok{)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{ggplot}\NormalTok{() }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{geom_point}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ Time, }\DataTypeTok{y =}\NormalTok{ Passes, }\DataTypeTok{color =}\NormalTok{ top_}\DecValTok{4}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-234-1.pdf}
...
\begin{center}\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-235-1} \end{center}
...
\begin{center}\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-235-2} \end{center}
...
\begin{center}\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-235-3} \end{center}
...
\begin{center}\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-235-4} \end{center}
...
\begin{center}\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-236-1} \end{center}
...
\StringTok{  }\KeywordTok{filter}\NormalTok{(Team }\OperatorTok{%in%}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"Spain"}\NormalTok{, }\StringTok{"Netherlands"}\NormalTok{, }\StringTok{"Germany"}\NormalTok{, }\StringTok{"Uruguay"}\NormalTok{)) }
\end{Highlighting}
\end{Shaded}
...
\begin{center}\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-238-1} \end{center}
...
\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-239-1.pdf}
...
\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-240-1.pdf}
...
\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-241-1.pdf}
\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-241-2.pdf}
\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-241-3.pdf}
\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-241-4.pdf}
\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-241-5.pdf}
...
\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-245-1.pdf}
...
\begin{center}\includegraphics[width=0.7\textwidth]{RProgrammingForResearch_files/figure-latex/unnamed-chunk-247-1} \end{center}
...
\begin{center}\includegraphics[width=0.5\textwidth]{RProgrammingForResearch_files/figure-latex/unnamed-chunk-248-1} \end{center}
...
\begin{center}\includegraphics[width=0.7\textwidth]{RProgrammingForResearch_files/figure-latex/unnamed-chunk-250-1} \end{center}
...
\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-253-1.pdf}
...
\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-257-1.pdf}
...
\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-259-1.pdf}
...
\begin{center}\includegraphics[width=0.8\textwidth]{RProgrammingForResearch_files/figure-latex/unnamed-chunk-262-1} \end{center}
...
\begin{center}\includegraphics[width=0.9\textwidth]{RProgrammingForResearch_files/figure-latex/unnamed-chunk-266-1} \end{center}
...
\includegraphics[width=0.32\textwidth]{RProgrammingForResearch_files/figure-latex/unnamed-chunk-267-1}
\includegraphics[width=0.32\textwidth]{RProgrammingForResearch_files/figure-latex/unnamed-chunk-267-2}
\includegraphics[width=0.32\textwidth]{RProgrammingForResearch_files/figure-latex/unnamed-chunk-267-3}
...
\includegraphics[width=\textwidth]{RProgrammingForResearch_files/figure-latex/unnamed-chunk-268-1}
...
\begin{center}\includegraphics[width=0.8\textwidth]{RProgrammingForResearch_files/figure-latex/unnamed-chunk-270-1} \end{center}
...
\StringTok{  }\NormalTok{tibble}\OperatorTok{::}\KeywordTok{rownames_to_column}\NormalTok{(}\DataTypeTok{var =} \StringTok{"Player"}\NormalTok{)}
\KeywordTok{head}\NormalTok{(worldcup, }\DecValTok{2}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-282-1.pdf}
...
\begin{Highlighting}[]
\NormalTok{worldcup <-}\StringTok{ }\NormalTok{worldcup }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{top_4 =}\NormalTok{ Team }\OperatorTok{%in%}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"Spain"}\NormalTok{, }\StringTok{"Germany"}\NormalTok{,  }
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{summary}\NormalTok{(worldcup}\OperatorTok{$}\NormalTok{top_}\DecValTok{4}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-285-2.pdf}
...
\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-285-3.pdf}
...
\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-285-4.pdf}
...
\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-285-5.pdf}
...
\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-285-6.pdf}
...
\begin{Highlighting}[]
\NormalTok{worldcup <-}\StringTok{ }\NormalTok{worldcup }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{top_4 =} \KeywordTok{factor}\NormalTok{(top_}\DecValTok{4}\NormalTok{, }\DataTypeTok{levels =} \KeywordTok{c}\NormalTok{(}\OtherTok{TRUE}\NormalTok{, }\OtherTok{FALSE}\NormalTok{),}
...
\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-289-1.pdf}
...
\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-290-1.pdf}
...
\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-292-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{top_player <-}\StringTok{ }\NormalTok{worldcup }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{top_n}\NormalTok{(}\DataTypeTok{n =} \DecValTok{1}\NormalTok{, }\DataTypeTok{wt =}\NormalTok{ Shots)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-296-1.pdf}
...
\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-297-1.pdf}

To create small multiples, use the \texttt{facet\_wrap()} command
(you'll probably want to use \texttt{ncol} to specify to use four
columns):

\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-298-1.pdf}
...
\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-299-1.pdf}
...
\begin{verbatim}
##         time          X          Y         Z
## 1 2009-01-01  0.2603905  1.4247997 -3.080969
## 2 2009-01-02 -0.3419164  0.3710948 -1.273949
## 3 2009-01-03 -0.7200136 -2.2632233 -3.459651
\end{verbatim}
...
\begin{verbatim}
##         time stock      price
## 1 2009-01-01     X  0.2603905
## 2 2009-01-02     X -0.3419164
## 3 2009-01-03     X -0.7200136
## 4 2009-01-04     X  0.1361167
## 5 2009-01-05     X  0.2735678
\end{verbatim}
...
\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-342-1.pdf}
...
\begin{verbatim}
##         time          X          Y          Z
## 1 2009-01-01  0.2603905  1.4247997 -3.0809687
## 2 2009-01-02 -0.3419164  0.3710948 -1.2739486
## 3 2009-01-03 -0.7200136 -2.2632233 -3.4596511
## 4 2009-01-04  0.1361167 -1.1575432 -2.7282059
## 5 2009-01-05  0.2735678 -0.4005741 -0.9154193
\end{verbatim}
...
##   stock     N        mean        sd
##   <chr> <int>       <dbl>     <dbl>
## 1     X    10 -0.07166045 0.9454017
## 2     Y    10 -0.23109407 1.1024449
## 3     Z    10 -2.54690069 2.8519706
\end{verbatim}
...
Statistic & X & Y & Z\\
\hline
Mean (Std.dev.) & -0.07 (0.95) & -0.23 (1.1) & -2.55 (2.85)\\
\hline
N & 10 & 10 & 10\\
\hline
\end{tabular}
...
\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-348-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{mex_deaths }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(}\OperatorTok{!}\NormalTok{(day }\OperatorTok{%in%}\StringTok{ }\NormalTok{mex_exp}\OperatorTok{$}\NormalTok{day))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{mex_exp }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(}\OperatorTok{!}\NormalTok{(day }\OperatorTok{%in%}\StringTok{ }\NormalTok{mex_deaths}\OperatorTok{$}\NormalTok{day))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{sum}\NormalTok{(}\OperatorTok{!}\NormalTok{(mex_deaths}\OperatorTok{$}\NormalTok{day }\OperatorTok{%in%}\StringTok{ }\NormalTok{mex_exp}\OperatorTok{$}\NormalTok{day))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{sum}\NormalTok{(}\OperatorTok{!}\NormalTok{(mex_exp}\OperatorTok{$}\NormalTok{day }\OperatorTok{%in%}\StringTok{ }\NormalTok{mex_deaths}\OperatorTok{$}\NormalTok{day))}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-359-1.pdf}
\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-359-2.pdf}
...
\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-360-1.pdf}
\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-360-2.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ebola <-}\StringTok{ }\NormalTok{ebola }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{gather}\NormalTok{(}\DataTypeTok{key =}\NormalTok{ variable, }\DataTypeTok{value =}\NormalTok{ count, }\OperatorTok{-}\NormalTok{Date, }\OperatorTok{-}\NormalTok{Day)}
\KeywordTok{head}\NormalTok{(ebola)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ebola <-}\StringTok{ }\NormalTok{ebola }\OperatorTok{%>%}
...
\begin{Highlighting}[]
\NormalTok{ebola <-}\StringTok{ }\NormalTok{ebola }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{separate}\NormalTok{(variable, }\KeywordTok{c}\NormalTok{(}\StringTok{"type"}\NormalTok{, }\StringTok{"country"}\NormalTok{), }\DataTypeTok{sep =} \StringTok{"_"}\NormalTok{)}
...
\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-367-1.pdf}
...
\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-367-2.pdf}
...
\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-368-1.pdf}
...
\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-368-2.pdf}
...
\StringTok{        }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{Date =} \KeywordTok{mdy}\NormalTok{(Date)) }\OperatorTok{%>%}
\StringTok{        }\KeywordTok{separate}\NormalTok{(variable, }\KeywordTok{c}\NormalTok{(}\StringTok{"type"}\NormalTok{, }\StringTok{"country"}\NormalTok{), }\DataTypeTok{sep =} \StringTok{"_"}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
...
\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-369-1.pdf}
...
\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-369-2.pdf}
...
\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-370-1.pdf}
...
\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-370-2.pdf}
...
\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-371-1.pdf}
...
\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-392-1.pdf}
...
\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-398-1.pdf}
...
\begin{Highlighting}[]
\NormalTok{subset_nepali <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(}\DataTypeTok{datafr =}\NormalTok{ nepali, child_id)\{}
  \ControlFlowTok{if}\NormalTok{(}\OperatorTok{!}\NormalTok{(}\StringTok{"id"} \OperatorTok{%in%}\StringTok{ }\KeywordTok{colnames}\NormalTok{(datafr)))\{}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{augment}\NormalTok{(mod_}\DecValTok{1}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{slice}\NormalTok{(}\DecValTok{1}\OperatorTok{:}\DecValTok{3}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\KeywordTok{augment}\NormalTok{(mod_}\DecValTok{1}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{ggplot}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ temp, }\DataTypeTok{y =}\NormalTok{ dptp)) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{geom_point}\NormalTok{(}\DataTypeTok{size =} \FloatTok{0.8}\NormalTok{, }\DataTypeTok{alpha =} \FloatTok{0.5}\NormalTok{, }\DataTypeTok{col =} \StringTok{"gray"}\NormalTok{) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{geom_line}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ temp, }\DataTypeTok{y =}\NormalTok{ .fitted), }\DataTypeTok{color =} \StringTok{"red"}\NormalTok{, }\DataTypeTok{size =} \DecValTok{2}\NormalTok{) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{theme_classic}\NormalTok{()}
\end{Highlighting}
\end{Shaded}

\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-445-1.pdf}
...
\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-446-1.pdf}
...
\KeywordTok{tidy}\NormalTok{(mod_}\DecValTok{1}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{select}\NormalTok{(term, estimate) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{inner_join}\NormalTok{(mod_1a }\OperatorTok{%>%}\StringTok{ }\KeywordTok{tidy}\NormalTok{() }\OperatorTok{%>%}\StringTok{ }\KeywordTok{select}\NormalTok{(term, estimate), }\DataTypeTok{by =} \StringTok{"term"}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{rename}\NormalTok{(}\DataTypeTok{estimate_lm_mod =}\NormalTok{ estimate.x,}
         \DataTypeTok{estimate_glm_mod =}\NormalTok{ estimate.y)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-452-1.pdf}
...
\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-453-1.pdf}
...
\StringTok{  }\KeywordTok{filter}\NormalTok{(month }\OperatorTok{%in%}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"Jun"}\NormalTok{, }\StringTok{"Jul"}\NormalTok{, }\StringTok{"Aug"}\NormalTok{))}
\NormalTok{summer }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{slice}\NormalTok{(}\DecValTok{1}\OperatorTok{:}\DecValTok{3}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{tidy}\NormalTok{(mod_}\DecValTok{3}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(term }\OperatorTok{==}\StringTok{ "temp"}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{log_rr =} \KeywordTok{exp}\NormalTok{(estimate))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{tidy}\NormalTok{(mod_}\DecValTok{3}\NormalTok{, }\DataTypeTok{conf.int =} \OtherTok{TRUE}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{select}\NormalTok{(term, estimate, conf.low, conf.high) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(term }\OperatorTok{==}\StringTok{ "temp"}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate_at}\NormalTok{(}\KeywordTok{vars}\NormalTok{(estimate}\OperatorTok{:}\NormalTok{conf.high), }\KeywordTok{funs}\NormalTok{(}\KeywordTok{exp}\NormalTok{(.)))}
\end{Highlighting}
\end{Shaded}
...
\begin{center}\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-459-1} \end{center}
...
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{date =} \KeywordTok{dmy_hm}\NormalTok{(date), }
         ...
         \DataTypeTok{weekend =}\NormalTok{ weekday }\OperatorTok{%in%}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"Saturday"}\NormalTok{, }\StringTok{"Sunday"}\NormalTok{)) }
...
\begin{center}\includegraphics{RProgrammingForResearch_files/figure-latex/check12-1} \end{center}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{colorado_data <-}\StringTok{ }\NormalTok{accident }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(state_name }\OperatorTok{==}\StringTok{ "Colorado"}\NormalTok{)}
 
\NormalTok{colorado_summary <-}\StringTok{ }\KeywordTok{summarize_fars}\NormalTok{(}\DataTypeTok{df =}\NormalTok{ colorado_data)}
\KeywordTok{head}\NormalTok{(colorado_summary)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# Note also that you can pipe with the new function:}
\NormalTok{accident }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(state_name }\OperatorTok{==}\StringTok{ "Texas"}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{summarize_fars}\NormalTok{() }\OperatorTok{%>%}\StringTok{ }
...
\NormalTok{accident }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(state_name }\OperatorTok{%in%}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"Colorado"}\NormalTok{, }\StringTok{"Texas"}\NormalTok{, }\StringTok{"California"}\NormalTok{, }\StringTok{"New York"}\NormalTok{)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{group_by}\NormalTok{(state_name) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{nest}\NormalTok{() }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{summary =} \KeywordTok{map}\NormalTok{(data, summarize_fars)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{select}\NormalTok{(}\OperatorTok{-}\NormalTok{data) }\OperatorTok{%>%}\StringTok{ }
...
\begin{center}\includegraphics{RProgrammingForResearch_files/figure-latex/check9-1} \end{center}
...
\begin{center}\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-465-1} \end{center}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{accident }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(state_name }\OperatorTok{==}\StringTok{ "Texas"}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{plot_fars}\NormalTok{() }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{print}\NormalTok{()}
\end{Highlighting}
\end{Shaded}

\begin{center}\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-465-2} \end{center}
...
\NormalTok{state_plots <-}\StringTok{ }\NormalTok{accident }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(state_name }\OperatorTok{%in%}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"Colorado"}\NormalTok{, }\StringTok{"Texas"}\NormalTok{, }\StringTok{"California"}\NormalTok{, }\StringTok{"New York"}\NormalTok{)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{group_by}\NormalTok{(state_name) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{nest}\NormalTok{() }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{plots =} \KeywordTok{map}\NormalTok{(data, plot_fars)) }

\KeywordTok{class}\NormalTok{(state_plots[[}\StringTok{"plots"}\NormalTok{]])}
\KeywordTok{class}\NormalTok{(state_plots[[}\StringTok{"plots"}\NormalTok{]][[}\DecValTok{1}\NormalTok{]])}
\KeywordTok{print}\NormalTok{(state_plots[[}\StringTok{"plots"}\NormalTok{]][[}\DecValTok{1}\NormalTok{]])}\OperatorTok{$}\NormalTok{plot}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{accident }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{filter}\NormalTok{(state_name }\OperatorTok{==}\StringTok{ "Colorado"}\NormalTok{) }\OperatorTok{%>%}
...
\NormalTok{accident }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{filter}\NormalTok{(state_name }\OperatorTok{==}\StringTok{ "Colorado"}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{daytime =} \KeywordTok{factor}\NormalTok{(daytime, }\DataTypeTok{labels =} \KeywordTok{c}\NormalTok{(}\StringTok{"Nighttime"}\NormalTok{, }\StringTok{"Daytime"}\NormalTok{)),}
         \DataTypeTok{drunk_dr =} \KeywordTok{factor}\NormalTok{(drunk_dr, }
                           \DataTypeTok{labels =} \KeywordTok{c}\NormalTok{(}\StringTok{"Not drunk driving"}\NormalTok{, }\StringTok{"Drunk driving"}\NormalTok{))) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{group_by}\NormalTok{(daytime, month, drunk_dr) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{summarize}\NormalTok{(}\DataTypeTok{accidents =} \KeywordTok{n}\NormalTok{()) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{ungroup}\NormalTok{() }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{unite}\NormalTok{(category, daytime, drunk_dr, }\DataTypeTok{sep =} \StringTok{" / "}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{spread}\NormalTok{(}\DataTypeTok{key =}\NormalTok{ category, }\DataTypeTok{value =}\NormalTok{ accidents) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\NormalTok{knitr}\OperatorTok{::}\KeywordTok{kable}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{summarize_fars <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(df)\{}
...
\NormalTok{accident }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{filter}\NormalTok{(state_name }\OperatorTok{==}\StringTok{ "Colorado"}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{drunk_dr =} \KeywordTok{factor}\NormalTok{(drunk_dr, }\DataTypeTok{labels =} \KeywordTok{c}\NormalTok{(}\StringTok{"Unrelated to}\CharTok{\textbackslash{}n}\StringTok{drunk driving"}\NormalTok{,}
...
\StringTok{  }\KeywordTok{ggtitle}\NormalTok{(}\KeywordTok{paste}\NormalTok{(}\StringTok{"Fatal accidents in"}\NormalTok{, }\StringTok{"Colorado"}\NormalTok{, }\StringTok{"in 2015"}\NormalTok{))}
\end{Highlighting}
\end{Shaded}

\begin{center}\includegraphics{RProgrammingForResearch_files/figure-latex/check3-1} \end{center}
...
\NormalTok{state_plots}
\KeywordTok{class}\NormalTok{(state_plots)}
\KeywordTok{class}\NormalTok{(state_plots[[}\StringTok{"plots"}\NormalTok{]])}
\KeywordTok{class}\NormalTok{(state_plots[[}\StringTok{"plots"}\NormalTok{]][[}\DecValTok{1}\NormalTok{]])}
\NormalTok{state_plots[[}\StringTok{"plots"}\NormalTok{]][[}\DecValTok{1}\NormalTok{]]}\OperatorTok{$}\NormalTok{plot}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{foo }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(col_}\DecValTok{1} \OperatorTok{==}\StringTok{ }\DecValTok{1}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{bar}\OperatorTok{$}\NormalTok{some_logical_values}
\end{Highlighting}
\end{Shaded}
...
## 
## $b
## [1] 0.58169110 0.33313005 0.02424575
## 
## $c
## [1] "a" "b" "c" "d"
\end{verbatim}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{north_carolina <-}\StringTok{ }\NormalTok{us_map }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(region }\OperatorTok{==}\StringTok{ "north carolina"}\NormalTok{)}
\KeywordTok{ggplot}\NormalTok{(north_carolina, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ long, }\DataTypeTok{y =}\NormalTok{ lat)) }\OperatorTok{+}
\StringTok{  }\KeywordTok{geom_point}\NormalTok{()}
\end{Highlighting}
\end{Shaded}

\begin{center}\includegraphics{RProgrammingForResearch_files/figure-latex/cav-1} \end{center}

If you try to plot lines, however, you'll have a problem:

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{carolinas <-}\StringTok{ }\NormalTok{us_map }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(}\KeywordTok{str_detect}\NormalTok{(region, }\StringTok{"carolina"}\NormalTok{))}
\KeywordTok{ggplot}\NormalTok{(carolinas, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ long, }\DataTypeTok{y =}\NormalTok{ lat)) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{geom_path}\NormalTok{()}
\end{Highlighting}
\end{Shaded}

\begin{center}\includegraphics{RProgrammingForResearch_files/figure-latex/caw-1} \end{center}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{carolinas }\OperatorTok{%>%}
...
\begin{center}\includegraphics{RProgrammingForResearch_files/figure-latex/cay-1} \end{center}
...
\begin{center}\includegraphics{RProgrammingForResearch_files/figure-latex/caz-1} \end{center}
...
\begin{center}\includegraphics{RProgrammingForResearch_files/figure-latex/cbb-1} \end{center}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{serial <-}\StringTok{ }\NormalTok{serial }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{long =} \OperatorTok{-}\FloatTok{76.8854} \OperatorTok{+}\StringTok{ }\FloatTok{0.00017022} \OperatorTok{*}\StringTok{ }\NormalTok{x,}
           \DataTypeTok{lat  =} \FloatTok{39.23822} \OperatorTok{+}\StringTok{ }\FloatTok{1.371014e-04} \OperatorTok{*}\StringTok{ }\NormalTok{y,}
           \DataTypeTok{tower =}\NormalTok{ Type }\OperatorTok{==}\StringTok{ "cell-site"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{baltimore <-}\StringTok{ }\KeywordTok{subset}\NormalTok{(baltimore, }
\NormalTok{                    subregion }\OperatorTok{%in%}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"baltimore city"}\NormalTok{,}
                                     \StringTok{"baltimore"}\NormalTok{))}
\KeywordTok{head}\NormalTok{(baltimore, }\DecValTok{3}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{RProgrammingForResearch_files/figure-latex/cbi-1.pdf}
...
\includegraphics{RProgrammingForResearch_files/figure-latex/cbl-1.pdf}
...
\includegraphics{RProgrammingForResearch_files/figure-latex/cbp-1.pdf}
...
\includegraphics{RProgrammingForResearch_files/figure-latex/cbq-1.pdf}
...
\includegraphics{RProgrammingForResearch_files/figure-latex/cbr-1.pdf}
...
\begin{center}\includegraphics{RProgrammingForResearch_files/figure-latex/cby-1} \end{center}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{serial_phone <-}\StringTok{ }\KeywordTok{read.csv}\NormalTok{(}\StringTok{"data/serial_phone_data.csv"}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
\StringTok{        }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{Cell_Site =} \KeywordTok{substring}\NormalTok{(Cell_Site, }\DecValTok{1}\NormalTok{, }\DecValTok{4}\NormalTok{),}
               \DataTypeTok{Call_Time =} \KeywordTok{as.POSIXct}\NormalTok{(Call_Time, }\DataTypeTok{format =} \StringTok{"%d/%m/%y %H:%M"}\NormalTok{,}
                                      \DataTypeTok{tz =} \StringTok{"EST"}\NormalTok{)) }\OperatorTok{%>%}
\StringTok{        }\KeywordTok{left_join}\NormalTok{(serial, }\DataTypeTok{by =} \KeywordTok{c}\NormalTok{(}\StringTok{"Cell_Site"}\NormalTok{ =}\StringTok{ "Name"}\NormalTok{)) }\OperatorTok{%>%}
\StringTok{        }\KeywordTok{select}\NormalTok{(Person_Called, Call_Time, Duration, long, lat) }\OperatorTok{%>%}
\StringTok{        }\KeywordTok{filter}\NormalTok{(}\OperatorTok{!}\NormalTok{(Person_Called }\OperatorTok{%in%}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"incoming"}\NormalTok{, }\StringTok{"# + Adnan cell"}\NormalTok{))) }\OperatorTok{%>%}
\StringTok{        }\KeywordTok{arrange}\NormalTok{(Call_Time)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{mapdist}\NormalTok{(}\StringTok{"Fort Collins CO"}\NormalTok{,}
        \StringTok{"1 First St NE, Washington, DC"}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{select}\NormalTok{(from, miles, hours)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{titanic_train}\OperatorTok{$}\NormalTok{Name[}\DecValTok{1}\NormalTok{]}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{str_to_upper}\NormalTok{(titanic_train}\OperatorTok{$}\NormalTok{Name[}\DecValTok{1}\NormalTok{])}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{str_to_lower}\NormalTok{(titanic_train}\OperatorTok{$}\NormalTok{Name[}\DecValTok{1}\NormalTok{])}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{str_to_title}\NormalTok{(}\KeywordTok{str_to_lower}\NormalTok{(titanic_train}\OperatorTok{$}\NormalTok{Name[}\DecValTok{1}\NormalTok{]))}
\end{Highlighting}
\end{Shaded}
...
\begin{center}\includegraphics{RProgrammingForResearch_files/figure-latex/check9a-1} \end{center}
...
\begin{center}\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-477-1} \end{center}
...
\begin{center}\includegraphics{RProgrammingForResearch_files/figure-latex/unnamed-chunk-477-2} \end{center}
...
\begin{center}\includegraphics{RProgrammingForResearch_files/figure-latex/check3a-1} \end{center}
...
\StringTok{  }\KeywordTok{group_by}\NormalTok{(state_name) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{nest}\NormalTok{() }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{plots =} \KeywordTok{map}\NormalTok{(data, plot_fars)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{select}\NormalTok{(state_name, plots)}
...
\includegraphics{RProgrammingForResearch_files/figure-latex/ccu-1.pdf}
\includegraphics{RProgrammingForResearch_files/figure-latex/ccu-2.pdf}
...
\begin{center}\includegraphics{RProgrammingForResearch_files/figure-latex/ccy-1} \end{center}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{accident }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{map_fatal_accidents}\NormalTok{(}\DataTypeTok{which_state =} \StringTok{"Texas"}\NormalTok{) }
\end{Highlighting}
\end{Shaded}

\begin{center}\includegraphics{RProgrammingForResearch_files/figure-latex/ccz-1} \end{center}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{accident }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{map_fatal_accidents}\NormalTok{(}\DataTypeTok{which_state =} \StringTok{"Colorado"}\NormalTok{, }\DataTypeTok{drunk_dr =} \OtherTok{TRUE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{center}\includegraphics{RProgrammingForResearch_files/figure-latex/cda-1} \end{center}
...
\begin{center}\includegraphics{RProgrammingForResearch_files/figure-latex/cdb-1} \end{center}

\part{Part IV: Advanced}\label{part-part-iv-advanced}

\chapter{Entering and cleaning data
\#3}\label{entering-and-cleaning-data-3}

\href{https://github.com/geanders/RProgrammingForResearch/raw/master/slides/CourseNotes_Week10.pdf}{Download}
a pdf of the lecture slides covering this topic.

\section{Cleaning very messy data}\label{cleaning-very-messy-data}

\subsection{Example of messy data}\label{example-of-messy-data}
...
\begin{center}\includegraphics[width=\textwidth]{figures/hurrtrackformat} \end{center}
...
\item
  Data for a storm starts with a shorter line, with values for the storm
  ID, name, and number of observations for the storm. These values are
  comma separated.
\item
  Observations for each storm are longer lines. There are multiple
  observations for each storm, where each observation gives values like
  the location and maximum winds for the storm at that time.
\end{itemize}

\subsection{Strategy for messy data}\label{strategy-for-messy-data}

Because the hurricane tracking data is not nicely formatted, you can't
use \texttt{read\_csv} or similar functions to read it in. Here is a
...
\item
  Use regular expressions to split each line into the elements you'd
  like to use to fill columns.
\item
  Write functions, loops, or \texttt{apply} calls to process lines and
  use the contents to fill a data frame.
\item
  Once you have the data in a data frame, do any remaining cleaning to
  create a data frame that is easy to use to answer research questions.
\end{enumerate}

\subsection{\texorpdfstring{\texttt{readLines}
function}{readLines function}}\label{readlines-function}

The \texttt{readLines} function allows you to read a text file in one
line at a time. You can then write code and functions to parse the file
one line at a time, to turn it into a dataframe you can use.

The \texttt{readLines} function will read in lines from a text file
directly, without trying to separate into columns. You can use the
\texttt{n} argument to specify the number of lines to read it.

For example, to read in three lines from the hurricane tracking data,
you can run:

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{tracks_url <-}\StringTok{ }\KeywordTok{paste0}\NormalTok{(}\StringTok{"http://www.nhc.noaa.gov/data/hurdat/"}\NormalTok{,}
                     \StringTok{"hurdat2-1851-2016-041117.txt"}\NormalTok{)}
\NormalTok{hurr_tracks <-}\StringTok{ }\KeywordTok{readLines}\NormalTok{(tracks_url, }\DataTypeTok{n =} \DecValTok{3}\NormalTok{)}
\NormalTok{hurr_tracks}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{class}\NormalTok{(hurr_tracks)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{length}\NormalTok{(hurr_tracks)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{hurr_tracks[}\DecValTok{1}\NormalTok{]}
\end{Highlighting}
\end{Shaded}
...
\subsection{Regular expressions for
cleaning}\label{regular-expressions-for-cleaning}

You can use regular expressions to break each line up. For example, you
can use \texttt{str\_split} from the \texttt{stringr} package to break
the first line of the hurricane track data into its three separate
components:

\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{library}\NormalTok{(stringr)}
\KeywordTok{str_split}\NormalTok{(hurr_tracks[}\DecValTok{1}\NormalTok{], }\DataTypeTok{pattern =} \StringTok{","}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
You can use this to create a list where each element of the list has the
split-up version of a line of the original data. First, read in all of
the data:
...
\NormalTok{tracks_url <-}\StringTok{ }\KeywordTok{paste0}\NormalTok{(}\StringTok{"http://www.nhc.noaa.gov/data/hurdat/"}\NormalTok{,}
                     \StringTok{"hurdat2-1851-2016-041117.txt"}\NormalTok{)}
\NormalTok{hurr_tracks <-}\StringTok{ }\KeywordTok{readLines}\NormalTok{(tracks_url)}
\KeywordTok{length}\NormalTok{(hurr_tracks)}
\end{Highlighting}
\end{Shaded}
...
Next, use \texttt{lapply} with \texttt{str\_split} to split each line of
the data at the commas:

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{hurr_tracks <-}\StringTok{ }\KeywordTok{lapply}\NormalTok{(hurr_tracks, str_split,}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{hurr_tracks[[}\DecValTok{2}\NormalTok{]][}\DecValTok{1}\OperatorTok{:}\DecValTok{2}\NormalTok{]}
\end{Highlighting}
\end{Shaded}
...
Next, you want to split this list into two lists, one with the shorter
``meta-data'' lines and one with the longer ``observation'' lines. You
can use \texttt{sapply} to create a vector with the length of each line.
You will later use this to identify which lines are short or long.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{hurr_lengths <-}\StringTok{ }\KeywordTok{sapply}\NormalTok{(hurr_tracks, length)}
\NormalTok{hurr_lengths[}\DecValTok{1}\OperatorTok{:}\DecValTok{17}\NormalTok{]}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{unique}\NormalTok{(hurr_lengths)}
\end{Highlighting}
\end{Shaded}
...
You can use bracket indexing to split the \texttt{hurr\_tracks} into two
lists: one with the shorter lines that start each observation
(\texttt{hurr\_meta}) and one with the storm observations
(\texttt{hurr\_obs}). Use bracket indexing with the
\texttt{hurr\_lengths} vector you just created to make that split.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{hurr_meta <-}\StringTok{ }\NormalTok{hurr_tracks[hurr_lengths }\OperatorTok{==}\StringTok{ }\DecValTok{4}\NormalTok{]}
\NormalTok{hurr_obs <-}\StringTok{ }\NormalTok{hurr_tracks[hurr_lengths }\OperatorTok{==}\StringTok{ }\DecValTok{21}\NormalTok{]}
\end{Highlighting}
\end{Shaded}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{hurr_meta[}\DecValTok{1}\OperatorTok{:}\DecValTok{3}\NormalTok{]}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{hurr_obs[}\DecValTok{1}\OperatorTok{:}\DecValTok{2}\NormalTok{]}
\end{Highlighting}
\end{Shaded}
...
\subsection{Converting to dataframes}\label{converting-to-dataframes}

Now, you can use \texttt{bind\_rows} from \texttt{dplyr} to change the
list of metadata into a dataframe. (You first need to use
\texttt{as\_tibble} with \texttt{lapply} to convert all elements of the
list from matrices to dataframes.)

\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{library}\NormalTok{(dplyr)}
\NormalTok{hurr_meta <-}\StringTok{ }\KeywordTok{lapply}\NormalTok{(hurr_meta, tibble}\OperatorTok{::}\NormalTok{as_tibble)}
\NormalTok{hurr_meta <-}\StringTok{ }\KeywordTok{bind_rows}\NormalTok{(hurr_meta)}
\NormalTok{hurr_meta }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{slice}\NormalTok{(}\DecValTok{1}\OperatorTok{:}\DecValTok{3}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\tightlist
\item
  First, the fourth column doesn't have any non-missing values, so you
  can get rid of it:
\end{itemize}

\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{unique}\NormalTok{(hurr_meta}\OperatorTok{$}\NormalTok{V4)}
\end{Highlighting}
\end{Shaded}
...
\tightlist
\item
  Second, the second and third columns include a lot of leading
  whitespace:
\end{itemize}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{hurr_meta}\OperatorTok{$}\NormalTok{V2[}\DecValTok{1}\OperatorTok{:}\DecValTok{2}\NormalTok{]}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{hurr_meta <-}\StringTok{ }\NormalTok{hurr_meta }\OperatorTok{%>%}
\StringTok{  }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{select}\NormalTok{(}\OperatorTok{-}\NormalTok{V4) }\OperatorTok{%>%}
\StringTok{  }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{rename}\NormalTok{(}\DataTypeTok{storm_id =}\NormalTok{ V1, }\DataTypeTok{storm_name =}\NormalTok{ V2, }\DataTypeTok{n_obs =}\NormalTok{ V3) }\OperatorTok{%>%}
\StringTok{  }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{storm_name =} \KeywordTok{str_trim}\NormalTok{(storm_name),}
                \DataTypeTok{n_obs =} \KeywordTok{as.numeric}\NormalTok{(n_obs))}
\NormalTok{hurr_meta }\OperatorTok{%>%}\StringTok{ }\KeywordTok{slice}\NormalTok{(}\DecValTok{1}\OperatorTok{:}\DecValTok{3}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
Now you can apply the same idea to the hurricane observations. First,
we'll want to add storm identifiers to that data. The ``meta'' data
includes storm ids and the number of observations per storm. We can take
advantage of that to make a \texttt{storm\_id} vector that will line up
with the storm observations.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{storm_id <-}\StringTok{ }\KeywordTok{rep}\NormalTok{(hurr_meta}\OperatorTok{$}\NormalTok{storm_id, }\DataTypeTok{times =}\NormalTok{ hurr_meta}\OperatorTok{$}\NormalTok{n_obs)}
\KeywordTok{head}\NormalTok{(storm_id, }\DecValTok{3}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{length}\NormalTok{(storm_id)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{length}\NormalTok{(hurr_obs)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{hurr_obs <-}\StringTok{ }\KeywordTok{lapply}\NormalTok{(hurr_obs, tibble}\OperatorTok{::}\NormalTok{as_tibble)}
\NormalTok{hurr_obs <-}\StringTok{ }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{bind_rows}\NormalTok{(hurr_obs) }\OperatorTok{%>%}
\StringTok{  }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{storm_id =}\NormalTok{ storm_id)}
\NormalTok{hurr_obs }\OperatorTok{%>%}\StringTok{ }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{select}\NormalTok{(V1, V2, V5, V6, storm_id) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{slice}\NormalTok{(}\DecValTok{1}\OperatorTok{:}\DecValTok{3}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
To finish, you just need to clean up the data. Now that the data is in a
dataframe, this process is inline with what you've been doing with
\texttt{dplyr} and related packages.

The ``README'' file for the hurricane tracking data is useful at this
point:

\url{http://www.nhc.noaa.gov/data/hurdat/hurdat2-format-atlantic.pdf}

First, say you only want some of the columns for a study you are doing.
You can use \texttt{select} to clean up the dataframe by limiting it to
columns you need.

If you only need date, time, storm status, location (latitude and
longitude), maximum sustained winds, and minimum pressure, then you can
run:

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{hurr_obs <-}\StringTok{ }\NormalTok{hurr_obs }\OperatorTok{%>%}
\StringTok{  }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{select}\NormalTok{(V1, V2, V4}\OperatorTok{:}\NormalTok{V8, storm_id) }\OperatorTok{%>%}
\StringTok{  }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{rename}\NormalTok{(}\DataTypeTok{date =}\NormalTok{ V1, }\DataTypeTok{time =}\NormalTok{ V2, }\DataTypeTok{status =}\NormalTok{ V4, }\DataTypeTok{latitude =}\NormalTok{ V5, }
                \DataTypeTok{longitude =}\NormalTok{ V6, }\DataTypeTok{wind =}\NormalTok{ V7, }\DataTypeTok{pressure =}\NormalTok{ V8)}
\NormalTok{hurr_obs }\OperatorTok{%>%}\StringTok{ }\KeywordTok{slice}\NormalTok{(}\DecValTok{1}\OperatorTok{:}\DecValTok{3}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{select}\NormalTok{(date, time, status, latitude, longitude)}
\end{Highlighting}
\end{Shaded}
...
Next, the first two columns give the date and time. You can
\texttt{unite} these and then convert them to a Date-time class.
...
\KeywordTok{library}\NormalTok{(lubridate)}
\NormalTok{hurr_obs <-}\StringTok{ }\NormalTok{hurr_obs }\OperatorTok{%>%}
\StringTok{  }\NormalTok{tidyr}\OperatorTok{::}\KeywordTok{unite}\NormalTok{(date_time, date, time) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{date_time =} \KeywordTok{ymd_hm}\NormalTok{(date_time))}
\NormalTok{hurr_obs }\OperatorTok{%>%}\StringTok{ }\KeywordTok{slice}\NormalTok{(}\DecValTok{1}\OperatorTok{:}\DecValTok{3}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{select}\NormalTok{(date_time, status, latitude, longitude)}
\end{Highlighting}
\end{Shaded}
...
Next, you can change \texttt{status} to a factor and give the levels
more meaningful names:

\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{unique}\NormalTok{(hurr_obs}\OperatorTok{$}\NormalTok{status)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{storm_levels <-}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"TD"}\NormalTok{, }\StringTok{"TS"}\NormalTok{, }\StringTok{"HU"}\NormalTok{, }\StringTok{"EX"}\NormalTok{, }
                  \StringTok{"SD"}\NormalTok{, }\StringTok{"SS"}\NormalTok{, }\StringTok{"LO"}\NormalTok{, }\StringTok{"WV"}\NormalTok{, }\StringTok{"DB"}\NormalTok{)}
\NormalTok{storm_labels <-}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"Tropical depression"}\NormalTok{, }\StringTok{"Tropical storm"}\NormalTok{,}
                  \StringTok{"Hurricane"}\NormalTok{, }\StringTok{"Extratropical cyclone"}\NormalTok{,}
                  \StringTok{"Subtropical depression"}\NormalTok{,}
                  \StringTok{"Subtropical storm"}\NormalTok{, }\StringTok{"Other low"}\NormalTok{,}
                  \StringTok{"Tropical wave"}\NormalTok{, }\StringTok{"Disturbance"}\NormalTok{)}
\NormalTok{hurr_obs <-}\StringTok{ }\NormalTok{hurr_obs }\OperatorTok{%>%}
\StringTok{  }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{status =} \KeywordTok{factor}\NormalTok{(}\KeywordTok{str_trim}\NormalTok{(status), }
                                \DataTypeTok{levels =}\NormalTok{ storm_levels, }
                                \DataTypeTok{labels =}\NormalTok{ storm_labels))}
\end{Highlighting}
\end{Shaded}

Now, you can clean up the latitude and longitude. Ultimately, we'll want
numeric values for those so we can use them for mapping. You can use
regular expressions to separate the numeric and non-numeric parts of
these columns. For example:

\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{head}\NormalTok{(}\KeywordTok{str_extract}\NormalTok{(hurr_obs}\OperatorTok{$}\NormalTok{latitude, }\StringTok{"[A-Z]"}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
Use this idea to split the numeric latitude from the direction of that
latitude:

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{hurr_obs <-}\StringTok{ }\NormalTok{hurr_obs }\OperatorTok{%>%}
\StringTok{  }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{lat_dir =} \KeywordTok{str_extract}\NormalTok{(latitude, }\StringTok{"[A-Z]"}\NormalTok{),}
                \DataTypeTok{latitude =} \KeywordTok{as.numeric}\NormalTok{(}\KeywordTok{str_extract}\NormalTok{(latitude, }\StringTok{"[^A-Z]+"}\NormalTok{)),}
                \DataTypeTok{lon_dir =} \KeywordTok{str_extract}\NormalTok{(longitude, }\StringTok{"[A-Z]"}\NormalTok{),}
                \DataTypeTok{longitude =} \KeywordTok{as.numeric}\NormalTok{(}\KeywordTok{str_extract}\NormalTok{(longitude, }\StringTok{"[^A-Z]+"}\NormalTok{)))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{hurr_obs }\OperatorTok{%>%}
\StringTok{  }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{select}\NormalTok{(latitude, lat_dir, longitude, lon_dir) }\OperatorTok{%>%}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{unique}\NormalTok{(hurr_obs}\OperatorTok{$}\NormalTok{lat_dir)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{unique}\NormalTok{(hurr_obs}\OperatorTok{$}\NormalTok{lon_dir)}
\end{Highlighting}
\end{Shaded}
...
If we're looking at US impacts, we probably only need observations from
the western hemisphere, so let's filter out other values:

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{hurr_obs <-}\StringTok{ }\NormalTok{hurr_obs }\OperatorTok{%>%}
\StringTok{  }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{filter}\NormalTok{(lon_dir }\OperatorTok{==}\StringTok{ "W"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{unique}\NormalTok{(hurr_obs}\OperatorTok{$}\NormalTok{wind)[}\DecValTok{1}\OperatorTok{:}\DecValTok{5}\NormalTok{]}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{hurr_obs <-}\StringTok{ }\NormalTok{hurr_obs }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{wind =} \KeywordTok{ifelse}\NormalTok{(wind }\OperatorTok{==}\StringTok{ " -99"}\NormalTok{, }\OtherTok{NA}\NormalTok{, }\KeywordTok{as.numeric}\NormalTok{(wind)))}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\KeywordTok{library}\NormalTok{(ggplot2)}
\KeywordTok{ggplot}\NormalTok{(hurr_obs, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ wind)) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{geom_histogram}\NormalTok{(}\DataTypeTok{binwidth =} \DecValTok{10}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{center}\includegraphics[width=0.8\textwidth]{RProgrammingForResearch_files/figure-latex/ch10chunk26-1} \end{center}

Clean and check air pressure measurements in the same way:

\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{head}\NormalTok{(}\KeywordTok{unique}\NormalTok{(hurr_obs}\OperatorTok{$}\NormalTok{pressure))}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\NormalTok{hurr_obs <-}\StringTok{ }\NormalTok{hurr_obs }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{pressure =} \KeywordTok{ifelse}\NormalTok{(pressure }\OperatorTok{==}\StringTok{ " -999"}\NormalTok{, }\OtherTok{NA}\NormalTok{,}
                                  \KeywordTok{as.numeric}\NormalTok{(pressure)))}
\end{Highlighting}
\end{Shaded}

\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{ggplot}\NormalTok{(hurr_obs, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ pressure)) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{geom_histogram}\NormalTok{(}\DataTypeTok{binwidth =} \DecValTok{5}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{center}\includegraphics[width=0.8\textwidth]{RProgrammingForResearch_files/figure-latex/ch10chunk28-1} \end{center}

Check some of the very low pressure measurements:

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{hurr_obs }\OperatorTok{%>%}\StringTok{ }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{arrange}\NormalTok{(pressure) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{select}\NormalTok{(date_time, wind, pressure) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{slice}\NormalTok{(}\DecValTok{1}\OperatorTok{:}\DecValTok{5}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\subsection{Exploring the hurricane tracking
data}\label{exploring-the-hurricane-tracking-data}

Explore pressure versus wind speed, by storm status:

\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{ggplot}\NormalTok{(hurr_obs, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ pressure, }\DataTypeTok{y =}\NormalTok{ wind,}
                     \DataTypeTok{color =}\NormalTok{ status)) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{geom_point}\NormalTok{(}\DataTypeTok{size =} \FloatTok{0.2}\NormalTok{, }\DataTypeTok{alpha =} \FloatTok{0.4}\NormalTok{) }
\end{Highlighting}
\end{Shaded}

\begin{center}\includegraphics[width=0.9\textwidth]{RProgrammingForResearch_files/figure-latex/ch10chunk30-1} \end{center}
...
\begin{Highlighting}[]
\NormalTok{hurr_obs <-}\StringTok{ }\NormalTok{hurr_obs }\OperatorTok{%>%}
\StringTok{  }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{decade =} \KeywordTok{substring}\NormalTok{(}\KeywordTok{year}\NormalTok{(date_time), }\DecValTok{1}\NormalTok{, }\DecValTok{3}\NormalTok{),}
                \DataTypeTok{decade =} \KeywordTok{paste0}\NormalTok{(decade, }\StringTok{"0s"}\NormalTok{))}
\KeywordTok{unique}\NormalTok{(hurr_obs}\OperatorTok{$}\NormalTok{decade)}
\end{Highlighting}
\end{Shaded}

\begin{verbatim}
##  [1] "1850s" "1860s" "1870s" "1880s" "1890s" "1900s" "1910s" "1920s"
...
\begin{Highlighting}[]
\NormalTok{hurr_obs <-}\StringTok{ }\NormalTok{hurr_obs }\OperatorTok{%>%}
\StringTok{  }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{group_by}\NormalTok{(storm_id) }\OperatorTok{%>%}
\StringTok{  }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{cat_5 =} \KeywordTok{max}\NormalTok{(wind) }\OperatorTok{>=}\StringTok{ }\DecValTok{137}\NormalTok{) }\OperatorTok{%>%}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{east_states <-}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"florida"}\NormalTok{, }\StringTok{"georgia"}\NormalTok{, }\StringTok{"south carolina"}\NormalTok{, }
                 \StringTok{"north carolina"}\NormalTok{, }\StringTok{"virginia"}\NormalTok{, }\StringTok{"maryland"}\NormalTok{,}
                 \StringTok{"delaware"}\NormalTok{, }\StringTok{"new jersey"}\NormalTok{, }\StringTok{"new york"}\NormalTok{, }
                 \StringTok{"connecticut"}\NormalTok{, }\StringTok{"massachusetts"}\NormalTok{, }
                 \StringTok{"rhode island"}\NormalTok{, }\StringTok{"vermont"}\NormalTok{, }\StringTok{"new hampshire"}\NormalTok{,}
                 \StringTok{"maine"}\NormalTok{, }\StringTok{"pennsylvania"}\NormalTok{, }\StringTok{"west virginia"}\NormalTok{,}
                 \StringTok{"tennessee"}\NormalTok{, }\StringTok{"kentucky"}\NormalTok{, }\StringTok{"alabama"}\NormalTok{,}
                 \StringTok{"arkansas"}\NormalTok{, }\StringTok{"texas"}\NormalTok{, }\StringTok{"mississippi"}\NormalTok{,}
                 \StringTok{"louisiana"}\NormalTok{)}
\NormalTok{east_us <-}\StringTok{ }\KeywordTok{map_data}\NormalTok{(}\StringTok{"state"}\NormalTok{, }\DataTypeTok{region =}\NormalTok{ east_states)}
\end{Highlighting}
\end{Shaded}

Plot tracks over a map of hurricane-prone states. Add thicker lines for
storms that were category 5 at least once in their history.

\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{ggplot}\NormalTok{(east_us, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ long, }\DataTypeTok{y =}\NormalTok{ lat, }\DataTypeTok{group =}\NormalTok{ group)) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{geom_polygon}\NormalTok{(}\DataTypeTok{fill =} \StringTok{"cornsilk"}\NormalTok{, }\DataTypeTok{color =} \StringTok{"cornsilk"}\NormalTok{) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{theme_void}\NormalTok{() }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{xlim}\NormalTok{(}\KeywordTok{c}\NormalTok{(}\OperatorTok{-}\DecValTok{108}\NormalTok{, }\OperatorTok{-}\DecValTok{65}\NormalTok{)) }\OperatorTok{+}\StringTok{ }\KeywordTok{ylim}\NormalTok{(}\KeywordTok{c}\NormalTok{(}\DecValTok{23}\NormalTok{, }\DecValTok{48}\NormalTok{)) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{geom_path}\NormalTok{(}\DataTypeTok{data =}\NormalTok{ hurr_obs, }
            \KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =} \OperatorTok{-}\NormalTok{longitude, }\DataTypeTok{y =}\NormalTok{ latitude,}
                \DataTypeTok{group =}\NormalTok{ storm_id),}
            \DataTypeTok{color =} \StringTok{"red"}\NormalTok{, }\DataTypeTok{alpha =} \FloatTok{0.2}\NormalTok{, }\DataTypeTok{size =} \FloatTok{0.2}\NormalTok{) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{geom_path}\NormalTok{(}\DataTypeTok{data =} \KeywordTok{filter}\NormalTok{(hurr_obs, cat_}\DecValTok{5}\NormalTok{), }
            \KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =} \OperatorTok{-}\NormalTok{longitude, }\DataTypeTok{y =}\NormalTok{ latitude,}
                \DataTypeTok{group =}\NormalTok{ storm_id),}
            \DataTypeTok{color =} \StringTok{"red"}\NormalTok{) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{facet_wrap}\NormalTok{(}\OperatorTok{~}\StringTok{ }\NormalTok{decade)}
\end{Highlighting}
\end{Shaded}

Check trends in maximum wind recorded in any observation each year:

\begin{center}\includegraphics[width=\textwidth]{RProgrammingForResearch_files/figure-latex/ch10chunk35-1} \end{center}
...
\begin{Highlighting}[]
\NormalTok{hurr_obs }\OperatorTok{%>%}
\StringTok{  }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{storm_year =} \KeywordTok{year}\NormalTok{(date_time)) }\OperatorTok{%>%}
\StringTok{  }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{group_by}\NormalTok{(storm_year) }\OperatorTok{%>%}
\StringTok{  }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{summarize}\NormalTok{(}\DataTypeTok{highest_wind =} \KeywordTok{max}\NormalTok{(wind, }\DataTypeTok{na.rm =} \OtherTok{TRUE}\NormalTok{)) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{ggplot}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ storm_year, }\DataTypeTok{y =}\NormalTok{ highest_wind)) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{geom_line}\NormalTok{() }\OperatorTok{+}\StringTok{ }\KeywordTok{geom_smooth}\NormalTok{(}\DataTypeTok{se =} \OtherTok{FALSE}\NormalTok{, }\DataTypeTok{span =} \FloatTok{0.5}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{center}\includegraphics[width=0.8\textwidth]{RProgrammingForResearch_files/figure-latex/ch10chunk36-1} \end{center}

There is an R package named \texttt{gender} that predicts whether a name
is male or female based on historical data:

\href{https://cran.r-project.org/web/packages/gender/vignettes/predicting-gender.html}{Vignette
for \texttt{gender} package}

This package uses one of several databases of names (here, we'll use
Social Security Administration data), inputs a year or range of years,
and outputs whether a name in that year was more likely female or male.

We can apply a function from this package across all the named storms to
see how male / female proportions changed over time.

First, install the package (as well as \texttt{genderdata}, which is
required to use the package). Once you do, you can use \texttt{gender}
to determine the most common gender associated with a name in a given
year or range of years:

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# install.packages("gender")}
\CommentTok{# install.packages("genderdata", type = "source",}
\CommentTok{#                 repos = "http://packages.ropensci.org")}
\KeywordTok{library}\NormalTok{(gender)}
\KeywordTok{gender}\NormalTok{(}\StringTok{"KATRINA"}\NormalTok{, }\DataTypeTok{years =} \DecValTok{2005}\NormalTok{)[ , }\KeywordTok{c}\NormalTok{(}\StringTok{"name"}\NormalTok{, }\StringTok{"gender"}\NormalTok{)]}
\end{Highlighting}
\end{Shaded}

To apply this function across all our storms, it helps if we write a
small function that ``wraps'' the \texttt{gender} function and outputs
exactly (and only) what we want, in the format we want:

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{get_gender <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(storm_name, storm_year)\{}
\NormalTok{  storm_gender <-}\StringTok{ }\KeywordTok{gender}\NormalTok{(}\DataTypeTok{names =}\NormalTok{ storm_name,}
                         \DataTypeTok{years =}\NormalTok{ storm_year,}
                         \DataTypeTok{method =} \StringTok{"ssa"}\NormalTok{)}\OperatorTok{$}\NormalTok{gender}
  \ControlFlowTok{if}\NormalTok{(}\KeywordTok{length}\NormalTok{(storm_gender) }\OperatorTok{==}\StringTok{ }\DecValTok{0}\NormalTok{) storm_gender <-}\StringTok{ }\OtherTok{NA}
  \KeywordTok{return}\NormalTok{(storm_gender)}
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}

Now we can use \texttt{mapply} with this wrapper function to apply it
across all our named storms:

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{hurr_genders <-}\StringTok{ }\NormalTok{hurr_meta }\OperatorTok{%>%}
\StringTok{  }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{filter}\NormalTok{(storm_name }\OperatorTok{!=}\StringTok{ "UNNAMED"}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{storm_year =} \KeywordTok{substring}\NormalTok{(storm_id, }\DecValTok{5}\NormalTok{, }\DecValTok{8}\NormalTok{),}
                \DataTypeTok{storm_year =} \KeywordTok{as.numeric}\NormalTok{(storm_year)) }\OperatorTok{%>%}
\StringTok{  }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{filter}\NormalTok{(}\DecValTok{1880} \OperatorTok{<=}\StringTok{ }\NormalTok{storm_year }\OperatorTok{&}\StringTok{ }\NormalTok{storm_year }\OperatorTok{<=}\StringTok{ }\DecValTok{2012}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{select}\NormalTok{(storm_name, storm_year, storm_id) }\OperatorTok{%>%}
\StringTok{  }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{storm_gender =} \KeywordTok{mapply}\NormalTok{(get_gender, }
                                      \DataTypeTok{storm_name =}\NormalTok{ storm_name,}
                                      \DataTypeTok{storm_year =} \KeywordTok{as.numeric}\NormalTok{(storm_year)))}
\end{Highlighting}
\end{Shaded}

Now, plot a bar chart with the number of male, female, and unclear
storms each year:

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{hurr_genders }\OperatorTok{%>%}
\StringTok{  }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{group_by}\NormalTok{(storm_year, storm_gender) }\OperatorTok{%>%}
\StringTok{  }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{summarize}\NormalTok{(}\DataTypeTok{n =} \KeywordTok{n}\NormalTok{()) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{ggplot}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ storm_year, }\DataTypeTok{y =}\NormalTok{ n, }\DataTypeTok{fill =}\NormalTok{ storm_gender)) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{geom_bar}\NormalTok{(}\DataTypeTok{stat =} \StringTok{"identity"}\NormalTok{) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{coord_flip}\NormalTok{() }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{scale_x_reverse}\NormalTok{() }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{theme_bw}\NormalTok{() }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{xlab}\NormalTok{(}\StringTok{""}\NormalTok{) }\OperatorTok{+}\StringTok{ }\KeywordTok{ylab}\NormalTok{(}\StringTok{"# of storms"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

Next, you can write a function to plot the track for a specific storm.
You'll want to be able to call the function by storm name and year, so
join in the storm names from the \texttt{hurr\_meta} dataset. We'll
exclude any ``UNNAMED'' storms.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{hurr_obs <-}\StringTok{ }\NormalTok{hurr_obs }\OperatorTok{%>%}
\StringTok{  }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{left_join}\NormalTok{(hurr_meta, }\DataTypeTok{by =} \StringTok{"storm_id"}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{filter}\NormalTok{(storm_name }\OperatorTok{!=}\StringTok{ "UNNAMED"}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{storm_year =} \KeywordTok{year}\NormalTok{(date_time))}
\end{Highlighting}
\end{Shaded}

Next, write a function to plot the track for a single storm. Use color
to show storm status and size to show wind speed.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{map_track <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(storm, year, }\DataTypeTok{map_data =}\NormalTok{ east_us,}
                      \DataTypeTok{hurr_data =}\NormalTok{ hurr_obs)\{}
\NormalTok{  to_plot <-}\StringTok{ }\NormalTok{hurr_obs }\OperatorTok{%>%}
\StringTok{    }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{filter}\NormalTok{(storm_name }\OperatorTok{==}\StringTok{ }\KeywordTok{toupper}\NormalTok{(storm) }\OperatorTok{&}\StringTok{ }\NormalTok{storm_year }\OperatorTok{==}\StringTok{ }\NormalTok{year)}
\NormalTok{  out <-}\StringTok{ }\KeywordTok{ggplot}\NormalTok{(east_us, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ long, }\DataTypeTok{y =}\NormalTok{ lat,}
                             \DataTypeTok{group =}\NormalTok{ group)) }\OperatorTok{+}\StringTok{ }
\StringTok{    }\KeywordTok{geom_polygon}\NormalTok{(}\DataTypeTok{fill =} \StringTok{"cornsilk"}\NormalTok{) }\OperatorTok{+}\StringTok{ }
\StringTok{    }\KeywordTok{theme_void}\NormalTok{() }\OperatorTok{+}\StringTok{ }
\StringTok{    }\KeywordTok{xlim}\NormalTok{(}\KeywordTok{c}\NormalTok{(}\OperatorTok{-}\DecValTok{108}\NormalTok{, }\OperatorTok{-}\DecValTok{65}\NormalTok{)) }\OperatorTok{+}\StringTok{ }\KeywordTok{ylim}\NormalTok{(}\KeywordTok{c}\NormalTok{(}\DecValTok{23}\NormalTok{, }\DecValTok{48}\NormalTok{)) }\OperatorTok{+}\StringTok{ }
\StringTok{    }\KeywordTok{geom_path}\NormalTok{(}\DataTypeTok{data =}\NormalTok{ to_plot,}
              \KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =} \OperatorTok{-}\NormalTok{longitude, }\DataTypeTok{y =}\NormalTok{ latitude,}
                  \DataTypeTok{group =} \OtherTok{NULL}\NormalTok{)) }\OperatorTok{+}\StringTok{ }
\StringTok{    }\KeywordTok{geom_point}\NormalTok{(}\DataTypeTok{data =}\NormalTok{ to_plot,}
              \KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =} \OperatorTok{-}\NormalTok{longitude, }\DataTypeTok{y =}\NormalTok{ latitude,}
                  \DataTypeTok{group =} \OtherTok{NULL}\NormalTok{, }\DataTypeTok{color =}\NormalTok{ status,}
                  \DataTypeTok{size =}\NormalTok{ wind), }\DataTypeTok{alpha =} \FloatTok{0.5}\NormalTok{)}
  \KeywordTok{return}\NormalTok{(out)}
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{map_track}\NormalTok{(}\DataTypeTok{storm =} \StringTok{"Katrina"}\NormalTok{, }\DataTypeTok{year =} \StringTok{"2005"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{center}\includegraphics[width=\textwidth]{RProgrammingForResearch_files/figure-latex/ch10chunk44-1} \end{center}

\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{map_track}\NormalTok{(}\DataTypeTok{storm =} \StringTok{"Camille"}\NormalTok{, }\DataTypeTok{year =} \StringTok{"1969"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{center}\includegraphics[width=\textwidth]{RProgrammingForResearch_files/figure-latex/ch10chunk45-1} \end{center}

\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{map_track}\NormalTok{(}\DataTypeTok{storm =} \StringTok{"Hazel"}\NormalTok{, }\DataTypeTok{year =} \StringTok{"1954"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{center}\includegraphics[width=\textwidth]{RProgrammingForResearch_files/figure-latex/ch10chunk46-1} \end{center}

You can also write code with \texttt{readLines} that will read, check,
and clean each line, one line at a time.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{con  <-}\StringTok{ }\KeywordTok{file}\NormalTok{(}\StringTok{"~/my_file.txt"}\NormalTok{, }\DataTypeTok{open =} \StringTok{"r"}\NormalTok{)}
\ControlFlowTok{while}\NormalTok{ (}\KeywordTok{length}\NormalTok{(single_line <-}\StringTok{ }
\StringTok{              }\KeywordTok{readLines}\NormalTok{(con, }\DataTypeTok{n =} \DecValTok{1}\NormalTok{,}
                        \DataTypeTok{warn =} \OtherTok{FALSE}\NormalTok{)) }\OperatorTok{>}\StringTok{ }\DecValTok{0}\NormalTok{) \{}
    
\NormalTok{  ## Code to check and clean each line and }
\NormalTok{  ## then add it to "cleaned" data frame.}
\NormalTok{  ## Run operations on `single_line`.}
...
This can be particularly useful if you're cleaning a very big file,
especially if there are many lines you don't want to keep.

\section{Pulling online data}\label{pulling-online-data}

\subsection{APIs}\label{apis}

API: ``Application Program Interface''

An API provides the rules for software applications to interact. In the
case of open data APIs, they provide the rules you need to know to write
R code to request and pull data from the organization's web server into
your R session.

Often, an API can help you avoid downloading all available data, and
instead only download the subset you need.
...
\item
  Once you get back data from the request, parse it into an
  easier-to-use format if necessary
\end{itemize}

Start by reading any documentation available for the API. This will
often give information on what data is available and how to put together
requests.

\begin{center}\includegraphics[width=1.1\textwidth]{figures/NASA_API_documentation} \end{center}

Source: \url{https://api.nasa.gov/api.html\#EONET}

Many organizations will require you to get an API key and use this key
in each of your API requests. This key allows the organization to
control API access, including enforcing rate limits per user. API rate
limits restrict how often you can request data (e.g., an hourly limit of
1,000 requests per user for NASA APIs).

You should keep this key private. In particular, make sure you do not
include it in code that is posted to GitHub.

\subsection{\texorpdfstring{Example-- \texttt{riem}
package}{Example-- riem package}}\label{example-riem-package}

The \texttt{riem} package, developed by Maelle Salmon and an ROpenSci
package, is an excellent and straightforward example of how you can use
R to pull open data through a web API.

This package allows you to pull weather data from airports around the
world directly from the \href{https://mesonet.agron.iastate.edu}{Iowa
Environmental Mesonet}.

To get a certain set of weather data from the Iowa Environmental
Mesonet, you can send an HTTP request specifying a base URL,
``\url{https://mesonet.agron.iastate.edu/cgi-bin/request/asos.py/}'', as
well as some parameters describing the subset of dataset you want (e.g.,
date ranges, weather variables, output format).

Once you know the rules for the names and possible values of these
parameters (more on that below), you can submit an HTTP GET request
using the \texttt{GET} function from the \texttt{httr} package.

\begin{center}\includegraphics[width=\textwidth]{figures/mesonet_example} \end{center}

\url{https://mesonet.agron.iastate.edu/cgi-bin/request/asos.py?station=DEN\&data=sknt\&year1=2016\&month1=6\&day1=1\&year2=2016\&month2=6\&day2=30\&tz=America\%2FDenver\&format=comma\&latlon=no\&direct=no\&report_type=1\&report_type=2}

When you are making an HTTP request using the \texttt{GET} or
\texttt{POST} functions from the \texttt{httr} package, you can include
the key-value pairs for any query parameters as a list object in the
\texttt{query} argurment of the function.

\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{library}\NormalTok{(httr)}
\NormalTok{meso_url <-}\StringTok{ }\KeywordTok{paste0}\NormalTok{(}\StringTok{"https://mesonet.agron.iastate.edu/"}\NormalTok{,}
                   \StringTok{"cgi-bin/request/asos.py/"}\NormalTok{)}
\NormalTok{denver <-}\StringTok{ }\KeywordTok{GET}\NormalTok{(}\DataTypeTok{url =}\NormalTok{ meso_url,}
              \DataTypeTok{query =} \KeywordTok{list}\NormalTok{(}\DataTypeTok{station =} \StringTok{"DEN"}\NormalTok{, }\DataTypeTok{data =} \StringTok{"sped"}\NormalTok{,}
                           \DataTypeTok{year1 =} \StringTok{"2016"}\NormalTok{, }\DataTypeTok{month1 =} \StringTok{"6"}\NormalTok{,}
                           \DataTypeTok{day1 =} \StringTok{"1"}\NormalTok{, }\DataTypeTok{year2 =} \StringTok{"2016"}\NormalTok{,}
                           \DataTypeTok{month2 =} \StringTok{"6"}\NormalTok{, }\DataTypeTok{day2 =} \StringTok{"30"}\NormalTok{,}
                           \DataTypeTok{tz =} \StringTok{"America/Denver"}\NormalTok{,}
                           \DataTypeTok{format =} \StringTok{"comma"}\NormalTok{))}
\end{Highlighting}
\end{Shaded}

You can then use \texttt{content} from \texttt{httr} to retrieve the
contents of the HTTP request. For this particular web data, the
requested data is a comma-separated file, so you can convert it to a
dataframe with \texttt{read\_csv}:

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{denver }\OperatorTok{%>%}\StringTok{ }\KeywordTok{content}\NormalTok{() }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\NormalTok{readr}\OperatorTok{::}\KeywordTok{read_csv}\NormalTok{(}\DataTypeTok{skip =} \DecValTok{5}\NormalTok{, }\DataTypeTok{na =} \StringTok{"M"}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{slice}\NormalTok{(}\DecValTok{1}\OperatorTok{:}\DecValTok{3}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\section{Example R API wrappers}\label{example-r-api-wrappers}

\subsection{rOpenSci}\label{ropensci}

rOpenSci (\url{https://ropensci.org}):

\begin{quote}
``At rOpenSci we are creating packages that allow access to data
repositories through the R statistical programming environment that is
already a familiar part of the workflow of many scientists. Our tools
not only facilitate drawing data into an environment where it can
readily be manipulated, but also one in which those analyses and methods
can be easily shared, replicated, and extended by other researchers.''
\end{quote}

rOpenSci collects a number of packages for tapping into open data for
research: \url{https://ropensci.org/packages}
...
\tightlist
\item
  \texttt{AntWeb}: Access data from the world's largest ant database
\item
  \texttt{chromer}: Interact with the chromosome counts database (CCDB)
\item
  \texttt{gender}: Encodes gender based on names and dates of birth
\item
  \texttt{musemeta}: R Client for Scraping Museum Metadata, including
  The Metropolitan Museum of Art, the Canadian Science \& Technology
  Museum Corporation, the National Gallery of Art, and the Getty Museum,
  and more to come.
\item
  \texttt{rusda}: Interface to some USDA databases
\item
  \texttt{webchem}: Retrieve chemical information from many sources.
  Currently includes: Chemical Identifier Resolver, ChemSpider, PubChem,
  and Chemical Translation Service.
\end{itemize}

For example, here is the description for the \texttt{rnoaa} package:

\begin{quote}
``Access climate data from NOAA, including temperature and
precipitation, as well as sea ice cover data, and extreme weather
events''
\end{quote}
...
\item
  Historical Observing Metadata Repository (HOMR))--- climate station
  metadata
\item
...
\subsection{\texorpdfstring{\texttt{countyweather}}{countyweather}}\label{countyweather}

The \texttt{countyweather} package wraps the \texttt{rnoaa} package to
let you pull and aggregate weather at the county level in the U.S. For
example, you can pull all data from Miami during Hurricane Andrew:

\includegraphics[width=\textwidth]{figures/countyweather2}

When you pull the data for a county, the package also maps the
contributing weather stations:

\includegraphics[width=\textwidth]{figures/countyweather1}

\subsection{USGS-R Packages}\label{usgs-r-packages}

USGS has a very nice collection of R packages that wrap USGS open data
APIs: \url{https://owi.usgs.gov/R/}

\begin{quote}
``USGS-R is a community of support for users of the R scientific
programming language. USGS-R resources include R training materials, R
tools for the retrieval and analysis of USGS data, and support for a
growing group of USGS-R developers.''
\end{quote}
...
\tightlist
\item
  \texttt{dataRetrieval}: Obtain water quality sample data, streamflow
  data, and metadata directly from either the USGS or EPA
\item
  \texttt{EGRET}: Analysis of long-term changes in water quality and
  streamflow, including the water-quality method Weighted Regressions on
  Time, Discharge, and Season (WRTDS)
\item
  \texttt{laketemps}: Lake temperature data package for Global Lake
  Temperature Collaboration Project
\item
  \texttt{lakeattributes}: Common useful lake attribute data
\item
  \texttt{soilmoisturetools}: Tools for soil moisture data retrieval and
  visualization
\end{itemize}

\subsection{U.S. Census packages}\label{u.s.-census-packages}

A number of R packages help you access and use data from the U.S.
Census:

\begin{itemize}
\tightlist
\item
  \texttt{tigris}: Download and use Census TIGER/Line shapefiles in R
\item
  \texttt{acs}: Download, manipulate, and present American Community
  Survey and Decennial data from the US Census
\item
  \texttt{USABoundaries}: Historical and contemporary boundaries of the
  United States of America
\item
  \texttt{idbr}: R interface to the US Census Bureau International Data
  Base API
\end{itemize}

For example, the \texttt{tigris} package allows you to pull spatial data
for:
...
Example from: Kyle Walker. 2016. ``tigris: An R Package to Access and
Work with Geographic Data from the US Census Bureau''. The R Journal.

\begin{center}\includegraphics[width=0.6\textwidth]{figures/tigris_example} \end{center}

\subsection{Other R API wrappers}\label{other-r-api-wrappers}

Here are some examples of other R packages that faciliate use of an API
for open data:

\begin{itemize}
\tightlist
\item
  \texttt{twitteR}: Twitter
\item
  \texttt{Quandl}: Quandl (financial data)
\item
  \texttt{RGoogleAnalytics}: Google Analytics
\item
  \texttt{WDI}, \texttt{wbstats}: World Bank
\item
  \texttt{GuardianR}, \texttt{rdian}: The Guardian Media Group
\item
  \texttt{blsAPI}: Bureau of Labor Statistics
\item
  \texttt{rtimes}: New York Times
\end{itemize}

\subsection{R and APIs}\label{r-and-apis}

Find out more about writing API packages with this vignette for the httr
package:
\url{https://cran.r-project.org/web/packages/httr/vignettes/api-packages.html}.

This document includes advice on error handling within R code that
accesses data through an open API.

\section{Parsing webpages}\label{parsing-webpages}

You can also use R to pull and clean web-based data that is not
accessible through a web API or as an online flat file.
...
The \texttt{rvest} package should be the first thing you try if you need
to pull and parse data from a webpage that is not a flat file.
...
later examples are from \texttt{rvest} documentation):

\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{library}\NormalTok{(rvest)}
\KeywordTok{read_html}\NormalTok{(}\StringTok{"<html><title>Hi<title></html>"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
If you have an HTML or XML page you want to pull data from, you'll first
need to read the page:

\includegraphics[width=\textwidth]{figures/moviereviewpage}

\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{library}\NormalTok{(rvest)}
\NormalTok{lego_movie <-}\StringTok{ }\KeywordTok{read_html}\NormalTok{(}\StringTok{"http://www.imdb.com/title/tt1490017/"}\NormalTok{)}
\NormalTok{lego_movie}
\end{Highlighting}
\end{Shaded}
...
Then you can use \texttt{html\_nodes} and \texttt{html\_text} to pull
and parse just the elements you want:

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{rating_node <-}\StringTok{ }\NormalTok{lego_movie }\OperatorTok{%>%}\StringTok{ }\KeywordTok{html_nodes}\NormalTok{(}\StringTok{"strong span"}\NormalTok{) }
\NormalTok{rating_node}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{rating <-}\StringTok{ }\NormalTok{rating_node }\OperatorTok{%>%}\StringTok{ }
\StringTok{    }\KeywordTok{html_text}\NormalTok{() }\OperatorTok{%>%}\StringTok{ }\KeywordTok{as.numeric}\NormalTok{()}
\NormalTok{rating}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{lego_movie }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{html_nodes}\NormalTok{(}\StringTok{"table"}\NormalTok{) }\OperatorTok{%>%}\StringTok{ `}\DataTypeTok{[[}\StringTok{`}\NormalTok{(}\DecValTok{1}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{html_table}\NormalTok{() }\OperatorTok{%>%}\StringTok{ }\KeywordTok{select}\NormalTok{(X2) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{slice}\NormalTok{(}\DecValTok{2}\OperatorTok{:}\DecValTok{8}\NormalTok{) }
\end{Highlighting}
\end{Shaded}
...
The only tricky part of this is figuring out which CSS selector you can
use to pull a specific element of a webpage.

You can use ``Selectorgadget'' to help with this. Read the vignette for
that tool here:
\url{ftp://cran.r-project.org/pub/R/web/packages/rvest/vignettes/selectorgadget.html}

\subsection{Scraping multiple pages}\label{scraping-multiple-pages}

{[}Need to update this-- Kitchen has changed their website{]}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{cities <-}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"denver"}\NormalTok{, }\StringTok{"boulder"}\NormalTok{, }\StringTok{"fort-collins"}\NormalTok{)}

\NormalTok{kitchen_addresses <-}\StringTok{ }\KeywordTok{c}\NormalTok{()}
\ControlFlowTok{for}\NormalTok{(i }\ControlFlowTok{in} \DecValTok{1}\OperatorTok{:}\KeywordTok{length}\NormalTok{(cities))\{}
\NormalTok{  restaurant_url <-}\StringTok{ }\KeywordTok{paste0}\NormalTok{(}\StringTok{"http://thekitchenbistros.com/the-kitchen-"}\NormalTok{,}
\NormalTok{                           cities[i])}
\NormalTok{  restaurant_page <-}\StringTok{ }\KeywordTok{read_html}\NormalTok{(restaurant_url)}
\NormalTok{  address <-}\StringTok{ }\NormalTok{restaurant_page }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{html_nodes}\NormalTok{(}\StringTok{"p:nth-child(2)"}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{html_text}\NormalTok{()}
\NormalTok{  kitchen_addresses[i] <-}\StringTok{ }\NormalTok{address[}\DecValTok{1}\NormalTok{]}
\NormalTok{\}}
\NormalTok{kitchen_addresses}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{library}\NormalTok{(ggmap)}
\KeywordTok{library}\NormalTok{(stringr)}
\NormalTok{kitchen_latlons <-}\StringTok{ }\KeywordTok{geocode}\NormalTok{(kitchen_addresses)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\ControlFlowTok{for}\NormalTok{(i }\ControlFlowTok{in} \DecValTok{1}\OperatorTok{:}\KeywordTok{length}\NormalTok{(cities))\{}
\NormalTok{  city_map <-}\StringTok{ }\KeywordTok{get_map}\NormalTok{(}\KeywordTok{paste}\NormalTok{(}\KeywordTok{gsub}\NormalTok{(}\StringTok{"-"}\NormalTok{, }\StringTok{" "}\NormalTok{, cities[i]),}
                            \StringTok{"colorado"}\NormalTok{),}
                      \DataTypeTok{zoom =} \DecValTok{14}\NormalTok{, }
                      \DataTypeTok{maptype =} \StringTok{"roadmap"}\NormalTok{)}
\NormalTok{  city_map <-}\StringTok{ }\KeywordTok{ggmap}\NormalTok{(city_map) }\OperatorTok{+}\StringTok{ }
\StringTok{    }\KeywordTok{geom_point}\NormalTok{(}\DataTypeTok{data =}\NormalTok{ kitchen_latlons[i, ],}
               \KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ lon, }\DataTypeTok{y =}\NormalTok{ lat),}
               \DataTypeTok{color =} \StringTok{"red"}\NormalTok{, }\DataTypeTok{size =} \DecValTok{4}\NormalTok{, }\DataTypeTok{alpha =} \FloatTok{0.4}\NormalTok{) }\OperatorTok{+}\StringTok{ }
\StringTok{    }\KeywordTok{theme_void}\NormalTok{() }\OperatorTok{+}\StringTok{ }
\StringTok{    }\KeywordTok{ggtitle}\NormalTok{(}\KeywordTok{paste}\NormalTok{(}\StringTok{"The Kitchen in"}\NormalTok{,}
                  \KeywordTok{str_to_title}\NormalTok{(}\KeywordTok{gsub}\NormalTok{(}\StringTok{"-"}\NormalTok{, }\StringTok{" "}\NormalTok{, cities[i]))))}
  \KeywordTok{print}\NormalTok{(city_map)}
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}
...
\item
  Mapping using \texttt{ggplot2} framework with dataframes of
  geographical data (in the slides, ``Point maps'')
\item
  Choropleths, \texttt{choroplethr}
\item
  \texttt{map\_data}
\item
  \texttt{get\_map}
